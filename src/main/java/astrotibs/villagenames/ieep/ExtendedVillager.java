...
/*
 * Villager summon Villager ~ ~ ~ {Profession:3}
 */
...
public class ExtendedVillager implements IExtendedEntityProperties {
    ...
    protected final static String InitializedKey = "Defined"; // Controls if a villager was assigned a career and career
                                                              // level
    ...
    /**
     * Used to register these extended properties for the villager during EntityConstructing event This method is for
    ...
    /**
     * Returns ExtendedPlayer properties for villager This method is for convenience only; it will make your code look
     * nicer
     */
    ...
    public static int determineProfessionLevel(EntityVillager villager) {
        ...
        if (villager.getProfession() == 5 && GeneralConfig.enableNitwit) {
            professionLevel = 0;
        }
