...
public class VillageWatcherAA {
    ...
    public static void setCustomTileTexture(String tileName, String printedName, String aaTileFileRoot) {
        ...
        tileAPI.setCustomTileTexture(
            ...
            tileAPI.registerTextureSet(
                printedName,
                new ResourceLocation(Reference.ANTIQUE_ATLAS_MODID, "textures/gui/tiles/" + aaTileFileRoot + ".png")));
    }
    ...
    VN_PATH = "VNPath", // VN Path
        ...
        SWAMP_HORRIBLE_SECRET = "VNSwHoSe", // Swamp Horrible Secret - NO MAPPING for this because it's supposed to be a
                                            // secret!
                ...
                if (markers != null) {
                    for (Marker marker : markers) {
                        if (marker.getType()
                            ...
                            if (GeneralConfig.debugMessages) {
                                LogHelper
                                    .info("Removed faux village marker at x=" + (chunkX << 4) + " z=" + (chunkZ << 4));
                            }
                            break;
                        }
                    }
