...
public class ModObjects {
    ...
    // public static final String GCAlienVillagerClass =
    // "micdoodle8.mods.galacticraft.core.entities.EntityAlienVillager";
    ...
    public static final String PMTravelingMerchantClass = "net.daveyx0.primitivemobs.entity.passive.EntityTravelingMerchant"; // Counts
                                                                                                                              // as
                                                                                                                              // a
                                                                                                                              // Villager
    public static final String PMLostMinerClass = "net.daveyx0.primitivemobs.entity.passive.EntityLostMiner"; // Counts
                                                                                                              // as a
                                                                                                              // Villager
    public static final String PMSheepmanClass = "net.daveyx0.primitivemobs.entity.passive.EntitySheepman"; // Counts as
                                                                                                            // a
                                                                                                            // Villager
    ...
    // Treasure maps
    public static final String fishingMap_MM = DOM_MANAMETAL + ":ItemFishingMaps"; // 0: bottled; 1: full map; 2: map
                                                                                   // fragment

    // Walls
    public static final String stoneWallEF = DOM_ETFUTURUM + ":stone_wall"; // 0: stone bricks; 1: mossy stone bricks ;
                                                                            // 2: sandstone ; 3: bricks
    public static final String bountifulWallEF = DOM_ETFUTURUM + ":stone_wall_2"; // 0: granite; 1: diorite ; 2:
                                                                                  // andesite
    ...
    public static ItemStack chooseModAndesiteItem() {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                .trim()
                .equals("uptodate") & VillageNames.canVillagerTradesDistinguishMeta) {
                    moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.stoneUTD));
                    if (moditem != null) {
                        return new ItemStack(moditem, 1, 5);
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("etfuturum") & VillageNames.canVillagerTradesDistinguishMeta) {
                        ...
                        .trim()
                        .equals("ganyssurface") & VillageNames.canVillagerTradesDistinguishMeta) {
                            ...
                            .trim()
                            .equals("botania") & VillageNames.canVillagerTradesDistinguishMeta) {
                                ...
                                .trim()
                                .equals("manametal") & VillageNames.canVillagerTradesDistinguishMeta) {
    ...
    public static ItemStack chooseModPolishedAndesiteItem() {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.andesiteC2));
                if (moditem != null) {
                    return new ItemStack(moditem, 1, 1);
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("uptodate")) {
                    moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.stoneUTD));
                    if (moditem != null) {
                        return new ItemStack(moditem, 1, 6);
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("etfuturum")) {
                        ...
                        .equals("ganyssurface")) {
                            ...
                            .equals("botania")) {
                                moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.stoneBo));
                                if (moditem != null) {
                                    return new ItemStack(moditem, 1, 4);
                                }
                            } else if (mod.toLowerCase()
                                .trim()
                                .equals("manametal") & VillageNames.canVillagerTradesDistinguishMeta) {
    ...
    public static Object[] chooseModPolishedAndesiteObject() {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                modblock = Block.getBlockFromName(ModObjects.andesiteC2);
                if (modblock != null) {
                    return new Object[] { modblock, new Integer(1) };
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("uptodate")) {
                    modblock = Block.getBlockFromName(ModObjects.stoneUTD);
                    if (modblock != null) {
                        return new Object[] { modblock, new Integer(6) };
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("etfuturum")) {
                        ...
                        .equals("ganyssurface")) {
                            ...
                            .equals("botania")) {
                                modblock = Block.getBlockFromName(ModObjects.stoneBo);
                                if (modblock != null) {
                                    return new Object[] { modblock, new Integer(4) };
                                }
                            } else if (mod.toLowerCase()
                                .trim()
                                .equals("manametal")) {
    ...
    public static Object[] chooseModPolishedAndesiteSlabObject(boolean upper) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                if (modblock != null) {
                    return new Object[] { modblock, upper ? 13 : 5 };
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("uptodate")) {
    ...
    public static Object[] chooseModBambooStalk(int state) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                if (modblock != null) {
                    return new Object[] { modblock, ef_to_vanilla };
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("biomesoplenty")) {
                    ...
                    .equals("growthcraft")) {
                        ...
                        .equals("manametal")) {
                            ...
                            if (modblock != null) {
                                return new Object[] { modblock, mm_to_vanilla };
                            }
                        }
        }
        return null;
    ...
    public static ItemStack chooseModBambooShoot() {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                if (moditem != null) {
                    return new ItemStack(moditem, 1, 2);
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("growthcraft")) {
    ...
    public static ItemStack chooseModBannerItem() {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                if (moditem != null) {
                    return new ItemStack(moditem, 1);
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("ganyssurface")) {
    ...
    public static void setModBedBlock(World world, int x, int y, int z, int orientationMeta, int colorMeta) {
        ...
        for (String mod : modprioritylist) {
            if (mod.toLowerCase()
                ...
                switch (colorMeta) {
                    case 0:
                        modblock = Block.getBlockFromName(ModObjects.bed_white_EFR);
                        break;
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.bed_orange_EFR);
                        break;
                    case 2:
                        modblock = Block.getBlockFromName(ModObjects.bed_magenta_EFR);
                        break;
                    case 3:
                        modblock = Block.getBlockFromName(ModObjects.bed_light_blue_EFR);
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.bed_yellow_EFR);
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.bed_lime_EFR);
                        break;
                    case 6:
                        modblock = Block.getBlockFromName(ModObjects.bed_pink_EFR);
                        break;
                    case 7:
                        modblock = Block.getBlockFromName(ModObjects.bed_gray_EFR);
                        break;
                    case 8:
                        modblock = Block.getBlockFromName(ModObjects.bed_light_gray_EFR);
                        break;
                    case 9:
                        modblock = Block.getBlockFromName(ModObjects.bed_cyan_EFR);
                        break;
                    case 10:
                        modblock = Block.getBlockFromName(ModObjects.bed_purple_EFR);
                        break;
                    case 11:
                        modblock = Block.getBlockFromName(ModObjects.bed_blue_EFR);
                        break;
                    case 12:
                        modblock = Block.getBlockFromName(ModObjects.bed_brown_EFR);
                        break;
                    case 13:
                        modblock = Block.getBlockFromName(ModObjects.bed_green_EFR);
                        break;
                    case 14:
                        modblock = Blocks.bed;
                        break;
                    case 15:
                        modblock = Block.getBlockFromName(ModObjects.bed_black_EFR);
                        break;
                }
                        ...
                        switch (colorMeta) {
                            ...
                            case 0:
                                ...
                                if (FunctionsVN.getItemFromName(ModObjects.bed_black_MM_item) != null) {
                                    modblock = Blocks.bed;
                                    break; // Equivalent to "white" bed
                                } else {
                                    continue;
                                }
                            case 1:
                                modblock = Block.getBlockFromName(ModObjects.bed_orange_MM_block);
                                break;
                            case 2:
                                modblock = Block.getBlockFromName(ModObjects.bed_magenta_MM_block);
                                break;
                            case 3:
                                modblock = Block.getBlockFromName(ModObjects.bed_lightBlue_MM_block);
                                break;
                            case 4:
                                modblock = Block.getBlockFromName(ModObjects.bed_yellow_MM_block);
                                break;
                            case 5:
                                modblock = Block.getBlockFromName(ModObjects.bed_lime_MM_block);
                                break;
                            case 6:
                                modblock = Block.getBlockFromName(ModObjects.bed_pink_MM_block);
                                break;
                            case 7:
                                modblock = Block.getBlockFromName(ModObjects.bed_gray_MM_block);
                                break;
                            case 8:
                                modblock = Block.getBlockFromName(ModObjects.bed_lightGray_MM_block);
                                break;
                            case 9:
                                modblock = Block.getBlockFromName(ModObjects.bed_cyan_MM_block);
                                break;
                            case 10:
                                modblock = Block.getBlockFromName(ModObjects.bed_purple_MM_block);
                                break;
                            case 11:
                                modblock = Block.getBlockFromName(ModObjects.bed_blue_MM_block);
                                break;
                            case 12:
                                modblock = Block.getBlockFromName(ModObjects.bed_brown_MM_block);
                                break;
                            case 13:
                                modblock = Block.getBlockFromName(ModObjects.bed_green_MM_block);
                                break;
                            case 14:
                                modblock = Block.getBlockFromName(ModObjects.bed_red_MM_block);
                                break;
                            case 15:
                                modblock = Block.getBlockFromName(ModObjects.bed_black_MM_block);
                                break;
                        }
    ...
    public static ItemStack chooseModBedItemStack(int colorMeta) {
        ...
        for (String mod : modprioritylist) {
            if (mod.toLowerCase()
                ...
                switch (colorMeta) {
                    case 0:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_white_EFR);
                        break;
                    case 1:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_orange_EFR);
                        break;
                    case 2:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_magenta_EFR);
                        break;
                    case 3:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_light_blue_EFR);
                        break;
                    case 4:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_yellow_EFR);
                        break;
                    case 5:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_lime_EFR);
                        break;
                    case 6:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_pink_EFR);
                        break;
                    case 7:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_gray_EFR);
                        break;
                    case 8:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_light_gray_EFR);
                        break;
                    case 9:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_cyan_EFR);
                        break;
                    case 10:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_purple_EFR);
                        break;
                    case 11:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_blue_EFR);
                        break;
                    case 12:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_brown_EFR);
                        break;
                    case 13:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_green_EFR);
                        break;
                    case 14:
                        moditem = Items.bed;
                        break;
                    case 15:
                        moditem = FunctionsVN.getItemFromName(ModObjects.bed_black_EFR);
                        break;
                }
                ...
                .equals("manametal")) {
                    switch (colorMeta) {
                        ...
                        case 1:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_orange_MM_item);
                            break;
                        case 2:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_magenta_MM_item);
                            break;
                        case 3:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_lightBlue_MM_item);
                            break;
                        case 4:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_yellow_MM_item);
                            break;
                        case 5:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_lime_MM_item);
                            break;
                        case 6:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_pink_MM_item);
                            break;
                        case 7:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_gray_MM_item);
                            break;
                        case 8:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_lightGray_MM_item);
                            break;
                        case 9:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_cyan_MM_item);
                            break;
                        case 10:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_purple_MM_item);
                            break;
                        case 11:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_blue_MM_item);
                            break;
                        case 12:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_brown_MM_item);
                            break;
                        case 13:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_green_MM_item);
                            break;
                        case 14:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_red_MM_item);
                            break;
                        case 15:
                            moditem = FunctionsVN.getItemFromName(ModObjects.bed_black_MM_item);
                            break;
                    }
    ...
    // Blast Furnace
    /**
     * furnaceOrientation: 0=fore-facing (away from you); 1=right-facing; 2=back-facing (toward you); 3=left-facing
     */
    ...
    public static Object[] chooseModBookshelf(int materialMeta) {
        ...
        for (String mod : modprioritylist) {
            if (mod.toLowerCase()
                ...
                switch (materialMeta) {
                    case 0:
                        modblock = Block.getBlockFromName(ModObjects.bookshelfOakWS);
                        meta = 0;
                        break;
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.bookshelfSpruceWS);
                        meta = 0;
                        break;
                    case 2:
                        modblock = Block.getBlockFromName(ModObjects.bookshelfBirchWS);
                        meta = 0;
                        break;
                    case 3:
                        modblock = Block.getBlockFromName(ModObjects.bookshelfJungleWS);
                        meta = 0;
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.bookshelfAcaciaWS);
                        meta = 0;
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.bookshelfDarkOakWS);
                        meta = 0;
                        break;
                }
                if (modblock != null) {
                ...
                .equals("ganyssurface")) {
                    ...
                    if (modblock != null) {
                        return new Object[] { modblock, materialMeta - 1 };
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("cement")) {
    ...
    // Campfire
    /**
     * Give this method the orientation of the campfire and the base mode of the structure it's in, and it'll give you
     * back the required meta value for construction. For relative orientations, use:
     * 
    ...
    public static Object[] chooseModCampfireBlock(int relativeOrientation, int coordBaseMode) {
        ...
        for (String mod : modprioritylist) {
            if (mod.toLowerCase()
                .trim()
                .equals("campfirebackport")) {
                modblock = Block.getBlockFromName(ModObjects.campfire_CB);
                if (modblock != null) {
                    return new Object[] { modblock,
                        StructureVillageVN.getSignRotationMeta(relativeOrientation, coordBaseMode, true) };
                }
            }
            if (mod.toLowerCase()
                .trim()
    ...
    public static Block chooseModChest(int woodMeta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (woodMeta) {
                    case 0:
                        modblock = Block.getBlockFromName(ModObjects.chestOakGS);
                        break;
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.chestSpruceGS);
                        break;
                    case 2:
                        modblock = Block.getBlockFromName(ModObjects.chestBirchGS);
                        break;
                    case 3:
                        modblock = Block.getBlockFromName(ModObjects.chestJungleGS);
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.chestAcaciaGS);
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.chestDarkOakGS);
                        break;
                }
                if (modblock != null) {
                    return modblock;
                ...
                .equals("woodstuff")) {
                    switch (woodMeta) {
                        case 0:
                            modblock = Block.getBlockFromName(ModObjects.chestOakWS);
                            break;
                        case 1:
                            modblock = Block.getBlockFromName(ModObjects.chestSpruceWS);
                            break;
                        case 2:
                            modblock = Block.getBlockFromName(ModObjects.chestBirchWS);
                            break;
                        case 3:
                            modblock = Block.getBlockFromName(ModObjects.chestJungleWS);
                            break;
                        case 4:
                            modblock = Block.getBlockFromName(ModObjects.chestAcaciaWS);
                            break;
                        case 5:
                            modblock = Block.getBlockFromName(ModObjects.chestDarkOakWS);
                            break;
                    }
                    if (modblock != null) {
                        return modblock;
    ...
    public static Object[] chooseModConcrete(int meta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                .trim()
                .equals("villagenames") && GeneralConfig.addConcrete) {
                ...
                .equals("uptodate")) {
                    ...
                    if (modblock != null) {
                        return new Object[] { modblock, new Integer(meta) };
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("etfuturum")) {
                        ...
                        switch (meta) {
                            case 0:
                                modblock = Block.getBlockFromName(ModObjects.concreteWhiteEF);
                                break;
                            case 1:
                                modblock = Block.getBlockFromName(ModObjects.concreteOrangeEF);
                                break;
                            case 2:
                                modblock = Block.getBlockFromName(ModObjects.concreteMagentaEF);
                                break;
                            case 3:
                                modblock = Block.getBlockFromName(ModObjects.concreteLightBlueEF);
                                break;
                            case 4:
                                modblock = Block.getBlockFromName(ModObjects.concreteYellowEF);
                                break;
                            case 5:
                                modblock = Block.getBlockFromName(ModObjects.concreteLimeEF);
                                break;
                            case 6:
                                modblock = Block.getBlockFromName(ModObjects.concretePinkEF);
                                break;
                            case 7:
                                modblock = Block.getBlockFromName(ModObjects.concreteGrayEF);
                                break;
                            case 8:
                                modblock = Block.getBlockFromName(ModObjects.concreteLightGrayEF);
                                break;
                            case 9:
                                modblock = Block.getBlockFromName(ModObjects.concreteCyanEF);
                                break;
                            case 10:
                                modblock = Block.getBlockFromName(ModObjects.concretePurpleEF);
                                break;
                            case 11:
                                modblock = Block.getBlockFromName(ModObjects.concreteBlueEF);
                                break;
                            case 12:
                                modblock = Block.getBlockFromName(ModObjects.concreteBrownEF);
                                break;
                            case 13:
                                modblock = Block.getBlockFromName(ModObjects.concreteGreenEF);
                                break;
                            case 14:
                                modblock = Block.getBlockFromName(ModObjects.concreteRedEF);
                                break;
                            case 15:
                                modblock = Block.getBlockFromName(ModObjects.concreteBlackEF);
                                break;
                        }
                        if (modblock != null) {
                            return new Object[] { modblock, new Integer(0) };
                        }
                    } else if (mod.toLowerCase()
                        .trim()
                        .equals("manametal")) {
    ...
    public static Object[] chooseModCraftingTable(int materialMeta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (materialMeta) {
                    case 0:
                        modblock = Block.getBlockFromName(ModObjects.craftingTableOakWS);
                        break;
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.craftingTableSpruceWS);
                        break;
                    case 2:
                        modblock = Block.getBlockFromName(ModObjects.craftingTableBirchWS);
                        break;
                    case 3:
                        modblock = Block.getBlockFromName(ModObjects.craftingTableJungleWS);
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.craftingTableAcaciaWS);
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.craftingTableDarkOakWS);
                        break;
                }
                if (modblock != null) {
                    return new Object[] { modblock, 0 };
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                .equals("uptodate") & VillageNames.canVillagerTradesDistinguishMeta) {
                    moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.stoneUTD));
                    if (moditem != null) {
                        return new ItemStack(moditem, 1, 3);
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("etfuturum") & VillageNames.canVillagerTradesDistinguishMeta) {
    ...
    public static Object[] chooseModDioriteSlabBlock(boolean upper) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                modblock = Block.getBlockFromName(ModObjects.stoneSlab2EF);
                if (modblock != null) {
                    return new Object[] { modblock, upper ? 10 : 2 };
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("uptodate")) {
    ...
    public static Object[] chooseModPolishedDioriteSlabBlock(boolean upper) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                modblock = Block.getBlockFromName(ModObjects.stoneSlab2EF);
                if (modblock != null) {
                    return new Object[] { modblock, upper ? 11 : 3 };
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("uptodate")) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                .equals("mariculture")) {
                    ...
                    if (moditem != null) {
                        return new ItemStack(moditem, 1, 28);
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("uptodate")) {
    ...
    public static ItemStack chooseModBlackDye() {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                moditem = FunctionsVN.getItemFromName(ModObjects.miscBOP);
                if (moditem != null) {
                    return new ItemStack(moditem, 1, 9);
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("uptodate")) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                .equals("mariculture")) {
                    moditem = FunctionsVN.getItemFromName(ModObjects.materialsMC);
                    if (moditem != null) {
                        return new ItemStack(moditem, 1, 32);
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("uptodate")) {
    ...
    public static ItemStack chooseModWhiteDye() {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                moditem = FunctionsVN.getItemFromName(ModObjects.miscBOP);
                if (moditem != null) {
                    return new ItemStack(moditem, 1, 8);
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("mariculture")) {
                    moditem = FunctionsVN.getItemFromName(ModObjects.materialsMC);
                    if (moditem != null) {
                        return new ItemStack(moditem, 1, 27);
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("uptodate")) {
    ...
    public static Object[] chooseModFence(int materialMeta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (materialMeta) {
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.fenceSpruceUTD);
                        break;
                    case 2:
                        modblock = Block.getBlockFromName(ModObjects.fenceBirchUTD);
                        break;
                    case 3:
                        modblock = Block.getBlockFromName(ModObjects.fenceJungleUTD);
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.fenceAcaciaUTD);
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.fenceDarkOakUTD);
                        break;
                }
                if (modblock != null) {
                    return new Object[] { modblock, 0 };
                ...
                .equals("etfuturum")) {
                    switch (materialMeta) {
                        case 0:
                            modblock = Block.getBlockFromName(ModObjects.fenceOakEF);
                            break;
                        case 1:
                            modblock = Block.getBlockFromName(ModObjects.fenceSpruceEF);
                            break;
                        case 2:
                            modblock = Block.getBlockFromName(ModObjects.fenceBirchEF);
                            break;
                        case 3:
                            modblock = Block.getBlockFromName(ModObjects.fenceJungleEF);
                            break;
                        case 4:
                            modblock = Block.getBlockFromName(ModObjects.fenceAcaciaEF);
                            break;
                        case 5:
                            modblock = Block.getBlockFromName(ModObjects.fenceDarkOakEF);
                            break;
                    }
                    if (modblock != null) {
                        return new Object[] { modblock, 0 };
                    ...
                    .equals("ganyssurface")) {
                        switch (materialMeta) {
                            case 0:
                                modblock = Block.getBlockFromName(ModObjects.fenceOakGS);
                                break;
                            case 1:
                                modblock = Block.getBlockFromName(ModObjects.fenceSpruceGS);
                                break;
                            case 2:
                                modblock = Block.getBlockFromName(ModObjects.fenceBirchGS);
                                break;
                            case 3:
                                modblock = Block.getBlockFromName(ModObjects.fenceJungleGS);
                                break;
                            case 4:
                                modblock = Block.getBlockFromName(ModObjects.fenceAcaciaGS);
                                break;
                            case 5:
                                modblock = Block.getBlockFromName(ModObjects.fenceDarkOakGS);
                                break;
                        }
                        if (modblock != null) {
                            return new Object[] { modblock, 0 };
                        ...
                        .equals("woodstuff")) {
                            switch (materialMeta) {
                                case 0:
                                    modblock = Block.getBlockFromName(ModObjects.fenceOakWS);
                                    break;
                                case 1:
                                    modblock = Block.getBlockFromName(ModObjects.fenceSpruceWS);
                                    break;
                                case 2:
                                    modblock = Block.getBlockFromName(ModObjects.fenceBirchWS);
                                    break;
                                case 3:
                                    modblock = Block.getBlockFromName(ModObjects.fenceJungleWS);
                                    break;
                                case 4:
                                    modblock = Block.getBlockFromName(ModObjects.fenceAcaciaWS);
                                    break;
                                case 5:
                                    modblock = Block.getBlockFromName(ModObjects.fenceDarkOakWS);
                                    break;
                            }
                            if (modblock != null) {
                                return new Object[] { modblock, 0 };
                            ...
                            .equals("manametal")) {
                                switch (materialMeta) {
                                    case 1:
                                        modblock = Block.getBlockFromName(ModObjects.fenceSpruceMM);
                                        break;
                                    case 2:
                                        modblock = Block.getBlockFromName(ModObjects.fenceBirchMM);
                                        break;
                                    case 3:
                                        modblock = Block.getBlockFromName(ModObjects.fenceJungleMM);
                                        break;
                                    case 4:
                                        modblock = Block.getBlockFromName(ModObjects.fenceAcaciaMM);
                                        break;
                                    case 5:
                                        modblock = Block.getBlockFromName(ModObjects.fenceDarkOakMM);
                                        break;
                                }
                                if (modblock != null) {
                                    return new Object[] { modblock, 0 };
    ...
    public static Block chooseModFenceGate(int materialMeta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (materialMeta) {
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.fenceGateSpruceUTD);
                        break;
                    case 2:
                        modblock = Block.getBlockFromName(ModObjects.fenceGateBirchUTD);
                        break;
                    case 3:
                        modblock = Block.getBlockFromName(ModObjects.fenceGateJungleUTD);
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.fenceGateAcaciaUTD);
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.fenceGateDarkOakUTD);
                        break;
                }
                if (modblock != null) {
                    return modblock;
                ...
                .equals("etfuturum")) {
                    switch (materialMeta) {
                        case 1:
                            modblock = Block.getBlockFromName(ModObjects.fenceGateSpruceEF);
                            break;
                        case 2:
                            modblock = Block.getBlockFromName(ModObjects.fenceGateBirchEF);
                            break;
                        case 3:
                            modblock = Block.getBlockFromName(ModObjects.fenceGateJungleEF);
                            break;
                        case 4:
                            modblock = Block.getBlockFromName(ModObjects.fenceGateAcaciaEF);
                            break;
                        case 5:
                            modblock = Block.getBlockFromName(ModObjects.fenceGateDarkOakEF);
                            break;
                    }
                    if (modblock != null) {
                        return modblock;
                    ...
                    .equals("ganyssurface")) {
                        switch (materialMeta) {
                            case 0:
                                modblock = Block.getBlockFromName(ModObjects.fenceGateOakGS);
                                break;
                            case 1:
                                modblock = Block.getBlockFromName(ModObjects.fenceGateSpruceGS);
                                break;
                            case 2:
                                modblock = Block.getBlockFromName(ModObjects.fenceGateBirchGS);
                                break;
                            case 3:
                                modblock = Block.getBlockFromName(ModObjects.fenceGateJungleGS);
                                break;
                            case 4:
                                modblock = Block.getBlockFromName(ModObjects.fenceGateAcaciaGS);
                                break;
                            case 5:
                                modblock = Block.getBlockFromName(ModObjects.fenceGateDarkOakGS);
                                break;
                        }
                        if (modblock != null) {
                            return modblock;
                        ...
                        .equals("malisisdoors")) {
                            switch (materialMeta) {
                                case 1:
                                    modblock = Block.getBlockFromName(ModObjects.fenceGateSpruceMD);
                                    break;
                                case 2:
                                    modblock = Block.getBlockFromName(ModObjects.fenceGateBirchMD);
                                    break;
                                case 3:
                                    modblock = Block.getBlockFromName(ModObjects.fenceGateJungleMD);
                                    break;
                                case 4:
                                    modblock = Block.getBlockFromName(ModObjects.fenceGateAcaciaMD);
                                    break;
                                case 5:
                                    modblock = Block.getBlockFromName(ModObjects.fenceGateDarkOakMD);
                                    break;
                            }
                            if (modblock != null) {
                                return modblock;
                            ...
                            .equals("manametal")) {
                                switch (materialMeta) {
                                    case 1:
                                        modblock = Block.getBlockFromName(ModObjects.fenceGateSpruceMM);
                                        break;
                                    case 2:
                                        modblock = Block.getBlockFromName(ModObjects.fenceGateBirchMM);
                                        break;
                                    case 3:
                                        modblock = Block.getBlockFromName(ModObjects.fenceGateJungleMM);
                                        break;
                                    case 4:
                                        modblock = Block.getBlockFromName(ModObjects.fenceGateAcaciaMM);
                                        break;
                                    case 5:
                                        modblock = Block.getBlockFromName(ModObjects.fenceGateDarkOakMM);
                                        break;
                                }
                                if (modblock != null) {
                                    return modblock;
                                ...
                                .equals("woodstuff")) {
                                    switch (materialMeta) {
                                        case 0:
                                            modblock = Block.getBlockFromName(ModObjects.fenceGateOakWS);
                                            break;
                                        case 1:
                                            modblock = Block.getBlockFromName(ModObjects.fenceGateSpruceWS);
                                            break;
                                        case 2:
                                            modblock = Block.getBlockFromName(ModObjects.fenceGateBirchWS);
                                            break;
                                        case 3:
                                            modblock = Block.getBlockFromName(ModObjects.fenceGateJungleWS);
                                            break;
                                        case 4:
                                            modblock = Block.getBlockFromName(ModObjects.fenceGateAcaciaWS);
                                            break;
                                        case 5:
                                            modblock = Block.getBlockFromName(ModObjects.fenceGateDarkOakWS);
                                            break;
                                    }
                                    if (modblock != null) {
                                        return modblock;
    ...
    public static Object[] chooseModGlazedTerracotta(int colorMeta, int orientationMeta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (colorMeta / 4) {
                    case 0:
                        modblock = ModBlocksVN.glazedTerracotta;
                        break;
                    case 1:
                        modblock = ModBlocksVN.glazedTerracotta2;
                        break;
                    case 2:
                        modblock = ModBlocksVN.glazedTerracotta3;
                        break;
                    case 3:
                        modblock = ModBlocksVN.glazedTerracotta4;
                        break;
                }
                ...
                .equals("etfuturum")) {
                    ...
                    switch (colorMeta) {
                        case 0:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaWhiteEF);
                            break;
                        case 1:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaOrangeEF);
                            break;
                        case 2:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaMagentaEF);
                            break;
                        case 3:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaLightBlueEF);
                            break;
                        case 4:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaYellowEF);
                            break;
                        case 5:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaLimeEF);
                            break;
                        case 6:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaPinkEF);
                            break;
                        case 7:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaGrayEF);
                            break;
                        case 8:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaLightGrayEF);
                            break;
                        case 9:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaCyanEF);
                            break;
                        case 10:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaPurpleEF);
                            break;
                        case 11:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaBlueEF);
                            break;
                        case 12:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaBrownEF);
                            break;
                        case 13:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaGreenEF);
                            break;
                        case 14:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaRedEF);
                            break;
                        case 15:
                            modblock = Block.getBlockFromName(ModObjects.glazedTerracottaBlackEF);
                            break;
                    }
                    if (modblock != null) {
                        return new Object[] { modblock, new Integer(orientationMeta) };
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("uptodate")) {
                        switch (colorMeta) {
                            case 0:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaWhiteUTD);
                                break;
                            case 1:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaOrangeUTD);
                                break;
                            case 2:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaMagentaUTD);
                                break;
                            case 3:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaLightBlueUTD);
                                break;
                            case 4:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaYellowUTD);
                                break;
                            case 5:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaLimeUTD);
                                break;
                            case 6:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaPinkUTD);
                                break;
                            case 7:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaGrayUTD);
                                break;
                            case 8:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaLightGrayUTD);
                                break;
                            case 9:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaCyanUTD);
                                break;
                            case 10:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaPurpleUTD);
                                break;
                            case 11:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaBlueUTD);
                                break;
                            case 12:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaBrownUTD);
                                break;
                            case 13:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaGreenUTD);
                                break;
                            case 14:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaRedUTD);
                                break;
                            case 15:
                                modblock = Block.getBlockFromName(ModObjects.glazedTerracottaBlackUTD);
                                break;
                        }
                        if (modblock != null) {
                            return new Object[] { modblock, new Integer(orientationMeta) };
                        ...
                        .equals("manametal")) {
                            ...
                            if (modblock != null) {
                                return new Object[] { modblock, new Integer(colorMeta) };
                            }
                        }
        }
        return null;
                    ...
                    .equals("etfuturum")) {
                        ...
                        .equals("ganyssurface")) {
                            ...
                            .equals("botania")) {
                                moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.stoneBo));
                                if (moditem != null) {
                                    return new ItemStack(moditem, 1, 7);
                                }
                            } else if (mod.toLowerCase()
                                .trim()
                                .equals("manametal")) {
    ...
    public static Object[] chooseModGrindstone(int orientation, int horizIndex, boolean isHanging) {
        ...
        int meta = VillageGeneratorConfigHandler.replaceAnvils ? 0
            : StructureVillageVN.chooseAnvilMeta(orientation, horizIndex);
                            ...
                            .equals("thermalfoundation")) {
                                ...
                                .equals("railcraft")) {
                                    ...
                                    .equals("mariculture")) {
                                        moditem = FunctionsVN.getItemFromName(ModObjects.materialsMC);
                                        if (moditem != null) {
                                            return new ItemStack(moditem, 1, 33);
                                        }
                                    } else if (mod.toLowerCase()
                                        .trim()
                                        .equals("netherlicious")) {
                                            ...
                                            .equals("ganysnether")) {
                                                ...
                                                .equals("manametal")) {
                                                    ...
                                                    .trim()
                                                    .equals("immersiveengineering")) {
                                                        moditem = FunctionsVN.getItemFromName(ModObjects.metalIE);
                                                        if (moditem != null) {
                                                            return new ItemStack(moditem, 1, 21);
                                                        }
                                                    }
    ...
    public static Object[] chooseModLanternBlock(boolean isHanging) {
        ...
        for (String mod : modprioritylist) {
            if (mod.toLowerCase()
                ...
                if (tryLantern != null) {
                    return new Object[] { tryLantern, isHanging ? 1 : 0 };
                } // 1 is hanging, 0 is sitting
            }
            if (mod.toLowerCase()
                .trim()
                .equals("etfuturum")) {
            ...
            if (mod.toLowerCase()
                ...
                if (tryLantern != null) {
                    return new Object[] { tryLantern, 1 };
                } // 1 is lit
            }
            if (mod.toLowerCase()
                .trim()
                .equals("manametal") && !isHanging) // No hanging version exists
            {
                Block tryLantern = Block.getBlockFromName(
                    isHanging ? ModObjects.ironLantern_hanging_MM : ModObjects.ironLantern_sitting_MM);
                if (tryLantern != null) {
                    return new Object[] { tryLantern, 2 };
                } // 2 is sitting and iron
            }
        }
            ...
            if (mod.toLowerCase()
                ...
                .equals("bibliocraft")) {
                    ...
                    .equals("manametal")) {
                        ...
                        if (moditem != null) {
                            return new ItemStack(moditem, 2);
                        } // 2 is iron
                    }
        }
        return null;
    ...
    // 3: south-facing
    // 0: west-facing
    public static final int[][] BIBLIOCRAFT_DESK_META_ARRAY = new int[][] { { 3, 0, 1, 2 }, // fore-facing (away from
                                                                                            // you)
    ...
    public static void setModLecternBlock(World world, int x, int y, int z, int orientation, int horizIndex,
        int woodMeta, int carpetColor) {
                ...
                .equals("manametal")) {
                    ...
                    if (modblock != null) {
                        world.setBlock(
                            ...
                            z,
                            modblock,
                            StructureVillageVN.chooseMMLecternMeta(orientation, horizIndex),
                            2);
    ...
    public static Object[] chooseModLoom(int orientation, int horizIndex, int woodMeta) {
        ...
        if (modblock != null) {
            return new Object[] { modblock, StructureVillageVN.chooseStonecutterMeta(orientation, horizIndex) };
        }
    ...
    // Ladder
    /**
     * Tries to convert to different wood ladder types. On a failure, return default vanilla ladder.
     */
    public static Block chooseModLadderBlock(int materialMeta) {
        ...
        switch (materialMeta) {
            case 0:
                modblock = Blocks.ladder;
                break;
            case 1:
                modblock = Block.getBlockFromName(ModObjects.ladderSpruceGS);
                break;
            case 2:
                modblock = Block.getBlockFromName(ModObjects.ladderBirchGS);
                break;
            case 3:
                modblock = Block.getBlockFromName(ModObjects.ladderJungleGS);
                break;
            case 4:
                modblock = Block.getBlockFromName(ModObjects.ladderAcaciaGS);
                break;
            case 5:
                modblock = Block.getBlockFromName(ModObjects.ladderDarkOakGS);
                break;
        }
        if (modblock != null) {
            return modblock;
    ...
    public static Object[] chooseModMossyCobblestoneSlabBlock(boolean upper) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                if (modblock != null) {
                    return new Object[] { modblock, upper ? 9 : 1 };
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("uptodate")) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                .equals("botania")) {
                    ...
                    if (moditem != null) {
                        return new ItemStack(moditem, 1, 10);
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("etfuturum")) {
    ...
    public static ItemStack chooseModWoodenSignItem(int materialMeta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (materialMeta) {
                    case 1:
                        moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signSpruceItem_EF));
                        break;
                    case 2:
                        moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signBirchItem_EF));
                        break;
                    case 3:
                        moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signJungleItem_EF));
                        break;
                    case 4:
                        moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signAcaciaItem_EF));
                        break;
                    case 5:
                        moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signDarkOakItem_EF));
                        break;
                }
                if (moditem != null) {
                    return new ItemStack(moditem, 1);
                ...
                .equals("ganyssurface")) {
                    switch (materialMeta) {
                        case 1:
                            moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signSpruce_GS));
                            break;
                        case 2:
                            moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signBirch_GS));
                            break;
                        case 3:
                            moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signJungle_GS));
                            break;
                        case 4:
                            moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signAcacia_GS));
                            break;
                        case 5:
                            moditem = Item.getItemFromBlock(Block.getBlockFromName(ModObjects.signDarkOak_GS));
                            break;
                    }
                    if (moditem != null) {
                        return new ItemStack(moditem, 1);
    ...
    public static Block chooseModWoodenSignBlock(int materialMeta, boolean standing) {
        ...
        } // Oak is just vanilla default

        Block modblock = null;

        switch (materialMeta) {
            case 1:
                modblock = Block.getBlockFromName(
                    standing ? ModObjects.standingSignSpruceBlock_EF : ModObjects.wallSignSpruceBlock_EF);
                break;
            case 2:
                modblock = Block.getBlockFromName(
                    standing ? ModObjects.standingSignBirchBlock_EF : ModObjects.wallSignBirchBlock_EF);
                break;
            case 3:
                modblock = Block.getBlockFromName(
                    standing ? ModObjects.standingSignJungleBlock_EF : ModObjects.wallSignJungleBlock_EF);
                break;
            case 4:
                modblock = Block.getBlockFromName(
                    standing ? ModObjects.standingSignAcaciaBlock_EF : ModObjects.wallSignAcaciaBlock_EF);
                break;
            case 5:
                modblock = Block.getBlockFromName(
                    standing ? ModObjects.standingSignDarkOakBlock_EF : ModObjects.wallSignDarkOakBlock_EF);
                break;

            // Gany's Surface uniquely uses boolean tile.isStanding in its tileentity which does not have a vanilla
            // parallel.
            // GS standing signs won't work.
            /*
             * case 1: modblock = Block.getBlockFromName(ModObjects.signSpruceGS); break; case 2: modblock =
             * Block.getBlockFromName(ModObjects.signBirchGS); break; case 3: modblock =
             * Block.getBlockFromName(ModObjects.signJungleGS); break; case 4: modblock =
             * Block.getBlockFromName(ModObjects.signAcaciaGS); break; case 5: modblock =
             * Block.getBlockFromName(ModObjects.signDarkOakGS); break;
             */
        }
        if (modblock != null) {
            return modblock;
    ...
    public static Object[] chooseModRedSandstoneSlab(boolean upper) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                if (modblock != null) {
                    return new Object[] { modblock, upper ? 1 : 0 };
                }
            }
            if (mod.toLowerCase()
                .trim()
    ...
    public static Object[] chooseModSmoothSandstoneBlock(boolean isRed) {
        ...
        for (String mod : modprioritylist) {
            if (mod.toLowerCase()
                ...
                .equals("etfuturum")) {
                modblock = Block
                    .getBlockFromName(isRed ? ModObjects.smoothRedSandstoneEF : ModObjects.smoothSandstoneEF);
                if (modblock != null) {
                    return new Object[] { modblock, 0 };
                }
            }
    ...
    // Stripped log
    /**
     * Materials are: 0=oak, 1=spruce, 2=birch, 3=jungle, 4=acacia, 5=darkoak Orientations are: 0=vertical, 1=east-west,
     * 2=north-south
     */
    public static Object[] chooseModStrippedLog(int materialMeta, int orientation) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (materialMeta) {
                    case 0:
                        modblock = Block.getBlockFromName(ModObjects.strippedLog1EF);
                        addMeta = 0;
                        break;
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.strippedLog1EF);
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.strippedLog2EF);
                        addMeta = 0;
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.strippedLog2EF);
                ...
                if (modblock != null) {
                    return new Object[] { modblock, orientation * 4 + addMeta };
                }
            } else if (mod.toLowerCase()
                .trim()
                .equals("uptodate")) {
                    switch (materialMeta) {
                        case 0:
                            modblock = Block.getBlockFromName(ModObjects.strippedLogOakUTD);
                            break;
                        case 1:
                            modblock = Block.getBlockFromName(ModObjects.strippedLogSpruceUTD);
                            break;
                        case 2:
                            modblock = Block.getBlockFromName(ModObjects.strippedLogBirchUTD);
                            break;
                        case 3:
                            modblock = Block.getBlockFromName(ModObjects.strippedLogJungleUTD);
                            break;
                        case 4:
                            modblock = Block.getBlockFromName(ModObjects.strippedLogAcaciaUTD);
                            break;
                        case 5:
                            modblock = Block.getBlockFromName(ModObjects.strippedLogDarkOakUTD);
                            break;
                    }
                    if (modblock != null) {
                        return new Object[] { modblock, orientation * 4 };
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("manametal")) {
                        ...
                        switch (materialMeta) {
                            case 0:
                                modblock = Block.getBlockFromName(ModObjects.strippedLog1_MM);
                                addMeta = 0;
                                break;
                            case 1:
                                modblock = Block.getBlockFromName(ModObjects.strippedLog1_MM);
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                modblock = Block.getBlockFromName(ModObjects.strippedLog2_MM);
                                addMeta = 0;
                                break;
                            case 5:
                                modblock = Block.getBlockFromName(ModObjects.strippedLog2_MM);
    ...
    public static Object[] chooseModStrippedWood(int materialMeta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (materialMeta) {
                    case 0:
                        modblock = Block.getBlockFromName(ModObjects.strippedWood1EF);
                        meta = 0;
                        break;
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.strippedWood1EF);
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.strippedWood2EF);
                        meta = 0;
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.strippedWood2EF);
    ...
    public static Block chooseModWoodenTrapdoor(int materialMeta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (materialMeta) {
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.trapdoorSpruceUTD);
                        break;
                    case 2:
                        modblock = Block.getBlockFromName(ModObjects.trapdoorBirchUTD);
                        break;
                    case 3:
                        modblock = Block.getBlockFromName(ModObjects.trapdoorJungleUTD);
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.trapdoorAcaciaUTD);
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.trapdoorDarkOakUTD);
                        break;
                }
                if (modblock != null) {
                    return modblock;
                ...
                .equals("etfuturum")) {
                    switch (materialMeta) {
                        case 1:
                            modblock = Block.getBlockFromName(ModObjects.trapdoorSpruceEF);
                            break;
                        case 2:
                            modblock = Block.getBlockFromName(ModObjects.trapdoorBirchEF);
                            break;
                        case 3:
                            modblock = Block.getBlockFromName(ModObjects.trapdoorJungleEF);
                            break;
                        case 4:
                            modblock = Block.getBlockFromName(ModObjects.trapdoorAcaciaEF);
                            break;
                        case 5:
                            modblock = Block.getBlockFromName(ModObjects.trapdoorDarkOakEF);
                            break;
                    }
                    if (modblock != null) {
                        return modblock;
                    ...
                    .equals("ganyssurface")) {
                        switch (materialMeta) {
                            case 1:
                                modblock = Block.getBlockFromName(ModObjects.trapdoorSpruceGS);
                                break;
                            case 2:
                                modblock = Block.getBlockFromName(ModObjects.trapdoorBirchGS);
                                break;
                            case 3:
                                modblock = Block.getBlockFromName(ModObjects.trapdoorJungleGS);
                                break;
                            case 4:
                                modblock = Block.getBlockFromName(ModObjects.trapdoorAcaciaGS);
                                break;
                            case 5:
                                modblock = Block.getBlockFromName(ModObjects.trapdoorDarkOakGS);
                                break;
                        }
                        if (modblock != null) {
                            return modblock;
            ...
            /*
             * else if (mod.toLowerCase().trim().equals("malisisdoors")) { switch (materialMeta) { case 1: modblock =
             * Block.getBlockFromName(ModObjects.trapdoorSpruceMD); break; case 2: modblock =
             * Block.getBlockFromName(ModObjects.trapdoorBirchMD); break; case 3: modblock =
             * Block.getBlockFromName(ModObjects.trapdoorJungleMD); break; case 4: modblock =
             * Block.getBlockFromName(ModObjects.trapdoorAcaciaMD); break; case 5: modblock =
             * Block.getBlockFromName(ModObjects.trapdoorDarkOakMD); break; } if (modblock != null) {return modblock;} }
             */
        }
        // If all else fails, grab the vanilla version
        return Blocks.trapdoor;
    ...
    public static ItemStack chooseModKelpBlock() {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                .trim()
                .equals("mariculture") & VillageNames.canVillagerTradesDistinguishMeta) {
                ...
                .trim()
                .equals("biomesoplenty") & VillageNames.canVillagerTradesDistinguishMeta) {
                    moditem = FunctionsVN.getItemFromName(ModObjects.kelpDriedBOP);
                    if (moditem != null) {
                        return new ItemStack(moditem, 9, 11);
                    } // Use nine because BoP doesn't have a way to consolidate them
                }
        }
        return null;
    }
    ...
    public static ItemStack chooseModSuspiciousStewRandom(Random random) {
        ...
        for (String mod : modprioritylist) {
            ...
            // PotionEffect effect = new PotionEffect(potionEffects[chosenPotionEffect][0],
            // potionEffects[chosenPotionEffect][1], 0);
    ...
    public static Block chooseModPressurePlate(int materialMeta) {
        ...
        for (String mod : modprioritylist) {
            ...
            if (mod.toLowerCase()
                ...
                switch (materialMeta) {
                    case 1:
                        modblock = Block.getBlockFromName(ModObjects.pressurePlateSpruceUTD);
                        break;
                    case 2:
                        modblock = Block.getBlockFromName(ModObjects.pressurePlateBirchUTD);
                        break;
                    case 3:
                        modblock = Block.getBlockFromName(ModObjects.pressurePlateJungleUTD);
                        break;
                    case 4:
                        modblock = Block.getBlockFromName(ModObjects.pressurePlateAcaciaUTD);
                        break;
                    case 5:
                        modblock = Block.getBlockFromName(ModObjects.pressurePlateDarkOakUTD);
                        break;
                }
                if (modblock != null) {
                    return modblock;
                ...
                .equals("etfuturum")) {
                    switch (materialMeta) {
                        case 1:
                            modblock = Block.getBlockFromName(ModObjects.pressurePlateSpruceEF);
                            break;
                        case 2:
                            modblock = Block.getBlockFromName(ModObjects.pressurePlateBirchEF);
                            break;
                        case 3:
                            modblock = Block.getBlockFromName(ModObjects.pressurePlateJungleEF);
                            break;
                        case 4:
                            modblock = Block.getBlockFromName(ModObjects.pressurePlateAcaciaEF);
                            break;
                        case 5:
                            modblock = Block.getBlockFromName(ModObjects.pressurePlateDarkOakEF);
                            break;
                    }
                    if (modblock != null) {
                        return modblock;
                    ...
                    .equals("ganyssurface")) {
                        switch (materialMeta) {
                            case 1:
                                modblock = Block.getBlockFromName(ModObjects.pressurePlateSpruceGS);
                                break;
                            case 2:
                                modblock = Block.getBlockFromName(ModObjects.pressurePlateBirchGS);
                                break;
                            case 3:
                                modblock = Block.getBlockFromName(ModObjects.pressurePlateJungleGS);
                                break;
                            case 4:
                                modblock = Block.getBlockFromName(ModObjects.pressurePlateAcaciaGS);
                                break;
                            case 5:
                                modblock = Block.getBlockFromName(ModObjects.pressurePlateDarkOakGS);
                                break;
                        }
                        if (modblock != null) {
                            return modblock;
                        ...
                        .equals("woodstuff")) {
                            switch (materialMeta) {
                                case 0:
                                    modblock = Block.getBlockFromName(ModObjects.pressurePlateOakWS);
                                    break;
                                case 1:
                                    modblock = Block.getBlockFromName(ModObjects.pressurePlateSpruceWS);
                                    break;
                                case 2:
                                    modblock = Block.getBlockFromName(ModObjects.pressurePlateBirchWS);
                                    break;
                                case 3:
                                    modblock = Block.getBlockFromName(ModObjects.pressurePlateJungleWS);
                                    break;
                                case 4:
                                    modblock = Block.getBlockFromName(ModObjects.pressurePlateAcaciaWS);
                                    break;
                                case 5:
                                    modblock = Block.getBlockFromName(ModObjects.pressurePlateDarkOakWS);
                                    break;
                            }
                            if (modblock != null) {
                                return modblock;
        ...
        for (String mod : modprioritylist) {
            if (mod.toLowerCase()
                ...
                .equals("bibliocraft")) {
                    ...
                    if (modblock != null) {
                        return new Object[][] { new Object[] { Blocks.air, 0 },
                            new Object[] { modblock, materialMeta } };
                    }
                } else if (mod.toLowerCase()
                    .trim()
                    .equals("mrcrayfishsfurnituremod")) {
                        modblock = Block.getBlockFromName(ModObjects.tablewood_CFM);

                        if (modblock != null) {
                            return new Object[][] { new Object[] { Blocks.air, 0 }, new Object[] { modblock, 0 } };
                        }
                    }
        }
        // If all else fails, grab the vanilla version
    ...
    public static Object[][] chooseVanillaWoodenTable(int materialMeta, int orientation, int horizIndex) {
        if (Loader.isModLoaded("bugtorch")) {
            return new Object[][] { new Object[] { ModObjects.chooseModPressurePlate(materialMeta), 0 },
                ModObjects.chooseModFence(materialMeta) };
        } else {
            if (ModObjects.chooseModPressurePlate(materialMeta) == Blocks.wooden_pressure_plate
                ...
                return new Object[][] { new Object[] { Blocks.wooden_pressure_plate, 0 },
                    new Object[] { Blocks.fence, 0 } };
            }

            if (orientation == -2) {
                // Put nothing here.
                return new Object[][] { new Object[] { Blocks.air, 0 }, new Object[] { Blocks.air, 0 } };
            }
    ...
    /**
     * Mods that haven't updated Village Names 4.4.7+ as a dependency (e.g. Mine Trading Cards) are calling the old
     * version of this method and will crash. This version operates as a placeholder for the old one.
     */
    @Deprecated
