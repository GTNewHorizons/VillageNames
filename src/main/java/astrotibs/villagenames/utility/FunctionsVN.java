...
public class FunctionsVN {
    ...
    public static enum MaterialType {
        ...
        MESA,
        SNOW,
        MUSHROOM; // Added three more for special non-wood cases
    ...
    public static int biomeToSkinType(BiomeGenBase biome) {
        ...
        // Mushroom type (10)
        if (typeList.contains(BiomeDictionary.Type.MUSHROOM)) {
            return 10;
        }

        // Savanna type (9)
        if (typeList.contains(BiomeDictionary.Type.HOT) && typeList.contains(BiomeDictionary.Type.MUSHROOM)) {
            return 9;
        }
        ...
        // Swamp type (6)
        if (typeList.contains(BiomeDictionary.Type.SWAMP)) {
            return 6;
        }
        ...
        // Plains type (0)
        if (typeList.contains(BiomeDictionary.Type.PLAINS)) {
            return 0;
        }
    ...
    /**
     * Check if the given entity is a original Zombie (normal, baby or villager), and not a inherited class (like Zombie
     * Pigman). Adapted from Villager Tweaks by sidben:
    ...
    public static boolean isTradeInappropriate(MerchantRecipe merchantrecipe, int profession, int career,
        ...
        switch (profession) {
            ...
            case 0: // Is a Farmer
                 ...
                 * ItemStack(Items.emerald, 1, 0), new ItemStack(Items.fish, 1, 0), new ItemStack(Items.cooked_fished,
                 * 1, 0))) ) { if ( GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==1 || slotPosition
                 * > 5) )) return false; else return true; } else if ( hasSameIDsAndMetasAs(merchantrecipe, new
                 * MerchantRecipe(new ItemStack(Items.fish, 1, 0), new ItemStack(Items.emerald, 1, 0))) ) { if (
                 * GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==2 || slotPosition > 5) )) return
                 * false; else return true; } else if ( hasSameIDsAndMetasAs(merchantrecipe, new MerchantRecipe(new
                 * ItemStack(Items.emerald, 1, 0), new ItemStack(Items.fish, 1, 1), new ItemStack(Items.cooked_fished,
                 * 1, 1))) ) { if ( GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==2 || slotPosition
                 * > 5) )) return false; else return true; } else if ( hasSameIDsAndMetasAs(merchantrecipe, new
                 * MerchantRecipe(new ItemStack(Items.fish, 1, 1), new ItemStack(Items.emerald, 1, 0))) ) { if (
                 * GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==3 || slotPosition > 5) )) return
                 * false; else return true; } else if ( hasSameIDsAndMetasAs(merchantrecipe, new MerchantRecipe(new
                 * ItemStack(Items.fish, 1, 2), new ItemStack(Items.emerald, 1, 0))) ) { if (
                 * GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==4 || slotPosition > 5) )) return
                 * false; else return true; } else if ( hasSameIDsAndMetasAs(merchantrecipe, new MerchantRecipe(new
                 * ItemStack(Items.fish, 1, 3), new ItemStack(Items.emerald, 1, 0))) ) { if (
                 * GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==5 || slotPosition > 5) )) return
            ...
            case 3: // summon Villager ~ ~ ~ {Profession:3}
                ...
                // Obsoleted generic trades
                    ...
                    // if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.gold_ingot, 1, 0), new
                    // ItemStack(Items.emerald, 1, 0))) ) return true;
                    // if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
                    // ItemStack(Items.iron_sword, 1, 0))) ) return true;
                    // if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
                    // ItemStack(Items.diamond_sword, 1, 0))) ) return true;
                    // if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
                    // ItemStack(Items.diamond_axe, 1, 0))) ) return true;
                    // if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
                    // ItemStack(Items.iron_pickaxe, 1, 0))) ) return true;
                    // if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
                    // ItemStack(Items.diamond_pickaxe, 1, 0))) ) return true;
                    // if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
            ...
            case 4: // summon Villager ~ ~ ~ {Profession:4}
                ...
                // Obsoleted generic trades
                /*
                 * else { //if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.beef, 1, 0), new
                 * ItemStack(Items.emerald, 1, 0))) ) return true; //if ( merchantrecipe.hasSameIDsAs(new
                 * MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new ItemStack(Items.leather_chestplate, 1, 0))) )
                 * return true; //if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1,
                 * 0), new ItemStack(Items.leather_boots, 1, 0))) ) return true; //if ( merchantrecipe.hasSameIDsAs(new
                 * MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new ItemStack(Items.leather_helmet, 1, 0))) )
                 * return true; //if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1,
                 * 0), new ItemStack(Items.cooked_beef, 1, 0))) ) return true; }
                 */
                break;
    ...
    /**
     * Copied from MerchantRecipeList.addToListWithCheck Checks if there is a recipe for the same ingredients already on
     * the list, and replaces it. Otherwise, adds it. If discriminateMetas is "true", this counts MerchantRecipes with
     * different meta values as being distinct. Otherwise, this trade replaces the first on the list with matching items
     * irrespective of meta (just like vanilla method).
     */
        ...
        for (int i = 0; i < recipeList.size(); ++i) {
            ...
            if ((discriminateMetas && hasSameIDsAndMetasAs(newRecipe, existingRecipe))
                ...
                if (hasSameItemsAs(newRecipe, existingRecipe)) // If this version is cheaper for the player, or offers a
                                                               // better deal, replace the one that's there
                {
                    // LogHelper.info("New recipe " + newRecipe + " has same items as existing recipe " +
                    // existingRecipe);
    ...
    /**
     * Checks first and second ItemToBuy ID's and count. If the asking price is lower or the offer amount is higher,
     * replace the trade with the better deal.
     */
    public static boolean hasSameItemsAs(MerchantRecipe newRecipe, MerchantRecipe existingRecipe) {
        ...
        {
            int buyitem1diff = newRecipe.getItemToBuy().stackSize - existingRecipe.getItemToBuy().stackSize; // Difference
                                                                                                             // between
                                                                                                             // old cost
                                                                                                             // and new
    ...
    /**
     * Combines colors and determines the resulting integer-encoded color. Colors are input as an int array of any
     * length, where each element is a dye meta color (e.g. 2 is magenta).
     */
    ...
    /**
     * Colorizes an itemstack using an encoded color integer. This is used to give a random two-dye color to leather
     * armor for the leatherworker.
     */
    public static ItemStack colorizeItemstack(ItemStack colorizableitemstack, int colorInt) {
        ...
        if (!nbttagcompound.hasKey("display", 10)) {
            nbttagcompound.setTag("display", tagcompounddisplay);
        }
    ...
    /**
     * Returns the cost of an item in a villager trade depending on the slot it's in and a priceMultiplier. The
     * "natural" cost is what it would be in slot 3 (Journeyman). The cost is always clamped between 1 and 64. A
     * priceMultiplier of N means that the item cost decreases by N for each slot after intendedSlot, and increases by N
     * for each slot before intendedSlot. A priceMultiplier of 0 thus means no change whatsoever. The price changing
     * effect of priceMultiplier is halved after slot 5.
     */
    ...
    /**
     * Adds a random enchanted book to a villager's trade offers in the style of 1.14 Copied and modified from
    ...
    public static ItemStack getRandomTippedArrow(int numberOfArrows, Random random) {
        ...
        if (EFtippedarrow == null) {
            return null;
        } // Et Futurum tipped arrows are not available.
        ...
        if (!nbttagcompound.hasKey("Potion", 10)) {
            nbttagcompound.setTag("Potion", tagcompoundPotion);
        }
    ...
    /**
     * Inputs an array of objects and a corresponding array of weights, and returns a randomly-selected element with a
     * probability proportional to its weight.
     * 
     * These inputs must be equal length. If they are not, you get back null. Additionally, and this goes without
     * saying: the individual weights must be non-negative and their sum must be positive.
     * 
    ...
    /**
     * Inputs a biome and returns a randomized skin tone value. Values are drawn from a Gaussian distribution and then
     * rounded to the nearest integer. The mean value of the distribution is the sum of values associated with each
     * biome tag. Most are 0 but some increase or decrease. The StDev value decreases as the Poisson error for number of
     * biome tags that have non-zero value. Config values determine the overall StDev scale, and how quickly the StDev
     * shrinks with number of biome tags. Possible output values range from -4 (darkest) to 3 (lightest) with 0 being
     * the standard Minecraft villager.
     */
    ...
    /**
     * Produces a shuffled array of integers from value a to value b. Primarily used to randomize the colored wool
     * variations granted to shepherds.
     */
    ...
    /**
     * Use this to adjust the villagers' trade when you talk to them. It essentially scans for and removes all vanilla
     * trades that aren't allowed by the new trade system.
     */
    public static void monitorVillagerTrades(EntityVillager villager) {
        if (villager.getProfession() < 0 || villager.getProfession() > 5) {
            return;
        } // Don't modify non-vanilla villager trades
        ...
        if (GeneralConfig.villagerCareers && villager.getProfession() >= 0 && villager.getProfession() <= 5) {
            final int failuresToForceAcceptance = 100; // How many invalid trade cycles are performed until we can
                                                       // assume this is an infinite loop
            ...
            true) {
                ...
                // buyingList = ReflectionHelper.getPrivateValue( EntityVillager.class, villager, new
                // String[]{"buyingList", "field_70963_i"} );
                ...
                while (true) {
                    ...
                    for (int i = buyingList.size() - 1; i >= 0; i--) {
                        ...
                        if (GeneralConfig.modernVillagerTrades) {
                            ...
                            // Librarian
                                ...
                                if (merchantrecipe.getItemToBuy() != null && merchantrecipe.getItemToBuy()
                                    ...
                                    // librarian.
                                    {
                                         ...
                                         * FunctionsVN.modernTradeCostBySlot((villager.worldObj.rand.nextInt(5 +
                                         * enchLevel * 10) + 3 * enchLevel), 1, slot, 3) ), new ItemStack(Items.book),
                                         * Items.enchanted_book.getEnchantedItemStack(new EnchantmentData(enchantment,
                                         * enchLevel)) )
                                         */
                                        );
                                    }
                            ...
                            /*
                             * if ( (profession==1 && (career==1 || career==2)) && merchantrecipe.hasSameIDsAs(new
                             * MerchantRecipe(new ItemStack(Items.paper, 1), new ItemStack(Items.emerald, 1) )) &&
                             * (merchantrecipe.getItemToBuy().stackSize < 22 || merchantrecipe.getItemToBuy().stackSize
                             * > 26) ) {buyingList.set(i, new MerchantRecipe( new ItemStack( Items.paper,
                             * FunctionsVN.modernTradeCostBySlot(24, 1, slot) ), new ItemStack(Items.emerald, 1) ));} if
                             * ( (profession==1 && career==1) && merchantrecipe.hasSameIDsAs(new MerchantRecipe(new
                             * ItemStack(Items.book, 1), new ItemStack(Items.emerald, 1) )) &&
                             * (merchantrecipe.getItemToBuy().stackSize < 4-2 || merchantrecipe.getItemToBuy().stackSize
                             * > 4+2) ) {buyingList.set(i, new MerchantRecipe( new ItemStack( Items.book,
                             * FunctionsVN.modernTradeCostBySlot(4, 1, slot) ), new ItemStack(Items.emerald, 1) ));} if
                             * ( (profession==2 && career==1) && merchantrecipe.hasSameIDsAs(new MerchantRecipe(new
                             * ItemStack(Items.emerald, 1), new ItemStack(Items.experience_bottle, 1) )) &&
                             * (merchantrecipe.getItemToSell().stackSize != 1) ) {buyingList.set(i, new MerchantRecipe(
                             * new ItemStack(Items.emerald, FunctionsVN.modernTradeCostBySlot(3, 1, slot)), new
                             * ItemStack( Items.experience_bottle, 1 ) ));} if ( (profession==2 && career==1) &&
                             * merchantrecipe.hasSameIDsAs(new MerchantRecipe(new ItemStack(Items.emerald, 1), new
                             * ItemStack(Items.redstone, 1) )) && (merchantrecipe.getItemToSell().stackSize != 2) )
                             * {buyingList.set(i, new MerchantRecipe( new ItemStack(Items.emerald,
                             * FunctionsVN.modernTradeCostBySlot(1, 1, slot)), new ItemStack( Items.redstone, 2 ) ));}
                             * /* if ( (profession==4 && career==1) && merchantrecipe.hasSameIDsAs(new
                             * MerchantRecipe(new ItemStack(Items.coal, 1), new ItemStack(Items.emerald, 1) )) &&
                             * (merchantrecipe.getItemToBuy().stackSize < 13 || merchantrecipe.getItemToBuy().stackSize
                             * > 17) ) {buyingList.set(i, new MerchantRecipe( new ItemStack( Items.coal,
                             * FunctionsVN.modernTradeCostBySlot(15, 1, slot) ), new ItemStack(Items.emerald, 1) ));}
                             */
                    ...
                    // If the buying list is the same size it was before culling, then it had no inappropriate trades
                    // removed. We can stop.
                ...
                if (buyingList.size() == listSizeBeforeCulling) {
                    ...
                    // If the dust has settled and the poor bastard has absolutely no trades, give him the ol' gold
                    // ingot.
                    ...
                    else if (!(GeneralConfig.modernVillagerTrades) && profession == 4 && career == 2) { // Profession:
                                                                                                        // Blacksmith
                ...
                // 4. Check the number of trades.
                // Should not be necessary because either it's unchanged from (3) or it was changed but then applied and
                // re-read above.
            ...
            // buyingList = ReflectionHelper.getPrivateValue( EntityVillager.class, villager, new String[]{"buyingList",
            // "field_70963_i"} );
        }
    }
    ...
    public static Item returnRandomBoatTypeForVillager(EntityVillager villager) {
        ...
        for (int i = 0; i < 6; i++) {
            if (boats[randomOrder[i]] != null) {
                return boats[randomOrder[i]];
            }
        }
    ...
    /**
     * Inputs an entity and returns a wood type for that entity based on its location. This is just in case we need to
     * base type on where that entity is. Useful for if a villager wants to sell an item made of a particular kind of
     * wood.
     * 
     * If you are in a biome with certain specific tags or words in the name, it will return a specific wood. Otherwise,
     * if you are in a biome with the "forest" tag it will return "oak." Failing all of that, it returns a random wood
     * type.
     */
    public static String chooseRandomWoodTypeFromLocation(EntityLiving entity) {
        ...
        for (BiomeDictionary.Type type : typeTags) {
            if (type == BiomeDictionary.Type.CONIFEROUS) {
                boatTypes.add("spruce");
                continue;
            }
            if (type == BiomeDictionary.Type.JUNGLE) {
                boatTypes.add("jungle");
                continue;
            }
            if (type == BiomeDictionary.Type.SAVANNA) {
                boatTypes.add("acacia");
                continue;
            }
    ...
    /**
     * Returns the median value of an int array. If the returned value is a halfway point, round up or down depending on
     * if the average value is higher or lower than the median. If it's the same, specify based on roundup parameter.
     */
        ...
        if (array.size() % 2 == 0) {
            ...
            if (sumOfMiddleTwo % 2 == 0) {
                ...
                if (average < median) {
                    ...
                    // LogHelper.info("Median chosen type D: " + (roundup ? MathHelper.ceiling_double_int(median) :
                    // MathHelper.floor_double(median)));
    ...
    /**
     * This method inputs three integers and returns a unique long value based on them. The purpose of this is to be
     * used as Random.setSeed(unique + worldseed) to ensure that randomized values for e.g. village names are
     * deterministic based on their coordinates so that they can be regenerated as necessary.
     */
    ...
    /**
     * Inputs two object arrays and joins them, sequentially placing array2 after array1 Adapted from
