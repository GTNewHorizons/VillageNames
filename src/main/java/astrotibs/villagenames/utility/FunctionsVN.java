...
public class FunctionsVN {
    ...
    public static boolean isTradeInappropriate(MerchantRecipe merchantrecipe, int profession, int career,
        ...
        switch (profession) {
            ...
            case 0: // Is a Farmer
                ...
                /*
                 * // Career = 2: Fisherman
                 * else if ( hasSameIDsAndMetasAs(merchantrecipe, new MerchantRecipe(new ItemStack(Items.emerald, 1, 0),
                 * new ItemStack(Items.fish, 1, 0), new ItemStack(Items.cooked_fished, 1, 0))) ) {
                 * if ( GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==1 || slotPosition > 5) ))
                 * return false; else return true; }
                 * else if ( hasSameIDsAndMetasAs(merchantrecipe, new MerchantRecipe(new ItemStack(Items.fish, 1, 0),
                 * new ItemStack(Items.emerald, 1, 0))) ) {
                 * if ( GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==2 || slotPosition > 5) ))
                 * return false; else return true; }
                 * else if ( hasSameIDsAndMetasAs(merchantrecipe, new MerchantRecipe(new ItemStack(Items.emerald, 1, 0),
                 * new ItemStack(Items.fish, 1, 1), new ItemStack(Items.cooked_fished, 1, 1))) ) {
                 * if ( GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==2 || slotPosition > 5) ))
                 * return false; else return true; }
                 * else if ( hasSameIDsAndMetasAs(merchantrecipe, new MerchantRecipe(new ItemStack(Items.fish, 1, 1),
                 * new ItemStack(Items.emerald, 1, 0))) ) {
                 * if ( GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==3 || slotPosition > 5) ))
                 * return false; else return true; }
                 * else if ( hasSameIDsAndMetasAs(merchantrecipe, new MerchantRecipe(new ItemStack(Items.fish, 1, 2),
                 * new ItemStack(Items.emerald, 1, 0))) ) {
                 * if ( GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==4 || slotPosition > 5) ))
                 * return false; else return true; }
                 * else if ( hasSameIDsAndMetasAs(merchantrecipe, new MerchantRecipe(new ItemStack(Items.fish, 1, 3),
                 * new ItemStack(Items.emerald, 1, 0))) ) {
                 * if ( GeneralConfig.modernVillagerTrades && (career==2 && (slotPosition==5 || slotPosition > 5) ))
                 * return false; else return true; }
                 */
            ...
            case 4: // summon Villager ~ ~ ~ {Profession:4}
                ...
                /*
                 * else {
                 * //if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.beef, 1, 0), new
                 * ItemStack(Items.emerald, 1, 0))) ) return true;
                 * //if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
                 * ItemStack(Items.leather_chestplate, 1, 0))) ) return true;
                 * //if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
                 * ItemStack(Items.leather_boots, 1, 0))) ) return true;
                 * //if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
                 * ItemStack(Items.leather_helmet, 1, 0))) ) return true;
                 * //if ( merchantrecipe.hasSameIDsAs(new MerchantRecipe( new ItemStack(Items.emerald, 1, 0), new
                 * ItemStack(Items.cooked_beef, 1, 0))) ) return true;
                 * }
                 */
                break;
     ...
     * Otherwise, this trade replaces the first on the list with matching items irrespective of meta (just like vanilla
     * method).
     */
     ...
     * A priceMultiplier of N means that the item cost decreases by N for each slot after intendedSlot, and increases by
     * N for each slot before intendedSlot.
     ...
     * Additionally, and this goes without saying: the individual weights must be non-negative and their sum must be
     * positive.
     * 
     ...
     * The mean value of the distribution is the sum of values associated with each biome tag. Most are 0 but some
                ...
                while (true) {
                    ...
                    for (int i = buyingList.size() - 1; i >= 0; i--) {
                        ...
                        if (GeneralConfig.modernVillagerTrades) {
                            ...
                            // Librarian
                                ...
                                if (merchantrecipe.getItemToBuy() != null && merchantrecipe.getItemToBuy()
                                    ...
                                    // librarian.
                                    {
                                         ...
                                         * enchLevel * 10) + 3 * enchLevel), 1, slot, 3) ),
                             ...
                             * && merchantrecipe.hasSameIDsAs(new MerchantRecipe(new ItemStack(Items.paper, 1), new
                             * ItemStack(Items.emerald, 1) ))
                             * && (merchantrecipe.getItemToBuy().stackSize < 22 ||
                             * merchantrecipe.getItemToBuy().stackSize > 26)
                             * )
                             ...
                             * && merchantrecipe.hasSameIDsAs(new MerchantRecipe(new ItemStack(Items.book, 1), new
                             * ItemStack(Items.emerald, 1) ))
                             * && (merchantrecipe.getItemToBuy().stackSize < 4-2 ||
                             * merchantrecipe.getItemToBuy().stackSize > 4+2)
                             * )
                             * {buyingList.set(i, new MerchantRecipe(
                             ...
                             * && merchantrecipe.hasSameIDsAs(new MerchantRecipe(new ItemStack(Items.coal, 1), new
                             * ItemStack(Items.emerald, 1) ))
                             * && (merchantrecipe.getItemToBuy().stackSize < 13 ||
                             * merchantrecipe.getItemToBuy().stackSize > 17)
                             * )
                             * {buyingList.set(i, new MerchantRecipe(
     ...
     * If the returned value is a halfway point, round up or down depending on if the average value is higher or lower
     * than the median.
