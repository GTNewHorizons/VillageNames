    ...
    public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer player) {
        ...
        if (!world.isRemote) {
            ...
            if (player.inventory.hasItem(Items.book)) {
                ...
                int[] BB = new int[6];
                boolean playerIsInVillage = false; // Set to true if you're in a village; used for Ghost Town
                                                   // achievement.
                ...
                structureLoop: for (int i = 0; i < structureTypes.size(); i++) {
                            ...
                            if (nbtbase.getId() == 10) {
                                ...
                                try {
                                    ...
                                    if (player.posX >= boundingBox[0] && player.posY >= boundingBox[1]
                                        ...
                                        // If none is found, these strings are "null" which parseInt does not like very
                                        // much
                                        try {
                                        ...
                                        // If a name was NOT returned, then we need to generate a new one, as is done
                                        // below:
                                        ...
                                        if (structureInfoArray[0] == null && structureInfoArray[1] == null
                                            ...
                                            if (!structureType.equals(structureTypes.get(i)))
                                                nbttagcompound1.setString("templeType", bookType);
                                            ...
                                            // .getTagList() will return all the entries under the specific village
                                            // name.
                                        ...
                                        try { // I'm enclosing this whole thing in a try/catch just in case casting to
                                              // EntityPlayerMP fails
        ...
        return itemStack; // Return what was passed in, because the codexWriteNewVillageBook method actually creates the
                          // book
    }
