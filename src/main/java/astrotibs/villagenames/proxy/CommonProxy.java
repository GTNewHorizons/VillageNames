...
public class CommonProxy {
    ...
    protected void registerAchievements() {
        ...
        /*
         * Name explanation from https://ghibli.fandom.com/wiki/Laputa:_Castle_in_the_Sky There are three decipher the
         * morse code in the film, which was never decoded fully. In the Japanese show Tsukai! Akashiya TV a former
         * soldier reveals its hidden meaning. The first code can be heard in the first chapter of the film. Muska take
         * a call, before he got knocked out by Sheeta hitting with an empty bottle. In the past, fans have dismissed
         * this message as jibberish, recording it as a repetition of a series of dots and dashes [�_ �_ �_], which
         * translates to nothing more than V V V. However, Sakai and his soldier mates, who have experience in
         * deciphering codes with no definite beginning and end, discovered that the message contained the code [.._. ..
         * _.. . ._.. .. _ _._ _ ], which spells out the word fidelity.
         */
