        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
            ...
            if (GeneralConfig.decorateVillageCenter)
            {
            	...
            	if (tryGlazedTerracotta != null)
            	{
            		...
            		this.placeBlockAtCurrentPosition(world, (Block)tryGlazedTerracotta[0], (Integer)tryGlazedTerracotta[1], 5, 4, 5, structureBB);
            		tryGlazedTerracotta = ModObjects.chooseModGlazedTerracotta(townColor2, (metaSpin + metaChirality)%4);
            		this.placeBlockAtCurrentPosition(world, (Block)tryGlazedTerracotta[0], (Integer)tryGlazedTerracotta[1], 5, 4, 6, structureBB);
            		tryGlazedTerracotta = ModObjects.chooseModGlazedTerracotta(townColor2, (metaSpin + metaChirality*2)%4);
            		this.placeBlockAtCurrentPosition(world, (Block)tryGlazedTerracotta[0], (Integer)tryGlazedTerracotta[1], 6, 4, 6, structureBB);
            		tryGlazedTerracotta = ModObjects.chooseModGlazedTerracotta(townColor2, (metaSpin + metaChirality*3)%4);
            		this.placeBlockAtCurrentPosition(world, (Block)tryGlazedTerracotta[0], (Integer)tryGlazedTerracotta[1], 6, 4, 5, structureBB);
            	}
            	else
            	{
