...
public class NamePieces {
	...
	public static final String VILLAGE_PREFIX_DEFAULT =
			"Bandar, Bandar, East, El, Flying, Fort, Half, Green, King, La, Le, Monte, Mount, New, New, North, Old, Port, Port, Port, Port, Port, Port, Port, Queen, S\u00e3o, S\u00e3o, Saint, Saint, Saint, Saint, San, San, San, San, San, San, San, San, Santa, Santo, Santo, South, Sri, St., St., St., St., St., St., St., St., The, The, Valley, West"
			;
	...
	public static final String VILLAGE_ROOT_SYL_BEGIN_DEFAULT =
	...
	public static final int[] VILLAGE_SYLLABLE_COUNT_WEIGHTS = new int[]{
			56, 275, 208, 91, 17, 2, 1
			};
	
	public static final int[] VILLAGE_BLANK_TERMINAL_COUNTS = new int[]{
			1, 85, 133, 69, 13, 2, 1
			};
	...
	public static final String MINESHAFT_ROOT_SYL_BEGIN_DEFAULT =
	...
	public static final int[] MINESHAFT_BLANK_TERMINAL_COUNTS = new int[]{
			1, 57, 46, 29, 6
			};
	...
	public static final String STRONGHOLD_ROOT_SYL_BEGIN_DEFAULT =
	...
	public static final int[] STRONGHOLD_BLANK_TERMINAL_COUNTS = new int[]{
			0, 14, 17, 13, 2
			};
	...
	public static final String TEMPLE_ROOT_SYL_BEGIN_DEFAULT =
	...
	public static final int[] TEMPLE_BLANK_TERMINAL_COUNTS = new int[]{
			2, 28, 38, 28, 2
			};
	...
	public static final String FORTRESS_ROOT_SYL_BEGIN_DEFAULT =
	...
	public static final int[] FORTRESS_BLANK_TERMINAL_COUNTS = new int[]{
			0, 10, 12, 8, 2
			};
	...
	public static final String MONUMENT_ROOT_SYL_BEGIN_DEFAULT =
	...
	public static final int[] MONUMENT_BLANK_TERMINAL_COUNTS = new int[]{
			0, 10, 7, 7, 5, 2
			};
	 ...
	 * Version 1.9 on
	 */
	public static final String END_CITY_PREFIX_DEFAULT =
			"End, Mag, T\u00edr"
			;
	
	public static final String END_CITY_ROOT_INITIAL_DEFAULT =
	...
	public static final String END_CITY_ROOT_SYL_BEGIN_DEFAULT =
	...
	public static final String END_CITY_SUFFIX_DEFAULT =
			"City"
			;

	public static final int[] END_CITY_SYLLABLE_COUNT_WEIGHTS = new int[]{
			5, 28, 24, 9, 1
			};

	public static final int[] END_CITY_BLANK_TERMINAL_COUNTS = new int[]{
			0, 7, 11, 5, 0
			};
	...
	public static final String MANSION_ROOT_SYL_BEGIN_DEFAULT =
	...
	public static final int[] MANSION_BLANK_TERMINAL_COUNTS = new int[]{
			2, 7, 13, 5, 1
			};
	...
	public static final String ALIEN_VILLAGE_ROOT_INITIAL_DEFAULT =
	...
	public static final String ALIEN_vILLAGE_ROOT_SYL_BEGIN_DEFAULT =
	...
	public static final int[] ALIEN_VILLAGE_SYLLABLE_COUNT_WEIGHTS = new int[]{
			25, 158, 123, 55, 20, 2
			};

	public static final int[] ALIEN_VILLAGE_BLANK_TERMINAL_COUNTS = new int[]{
			1, 48, 31, 19, 4, 1
			};
