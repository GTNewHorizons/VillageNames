...
public class NamePieces {
    ...
    public static final String TEMPLE_SUFFIX_DEFAULT = "Hill, Magna, Qim";

    public static final int[] TEMPLE_SYLLABLE_COUNT_WEIGHTS = new int[] { 20, 87, 83, 52, 6 };

    public static final int[] TEMPLE_BLANK_TERMINAL_COUNTS = new int[] { 2, 28, 38, 28, 2 };

    /*
     * Fortress name pieces
     */
    public static final String FORTRESS_PREFIX_DEFAULT = "Nether";

    public static final String FORTRESS_ROOT_INITIAL_DEFAULT = "\u00c9, A, A, A, A, A, A, A, Aea, Ca, Cae, Ce, Ce, Cha, Chi, Ci, Co, Di, Di, Dra, Du, E, E, E, Eu, Fey, Ga, Gj\u00f6, Gja, Go, Ha, Ha, He, He, He, Hy, Hy, I, La, Le, Le, M\u00f3, Me, Me, Mi, Mi, Mu, Mu, N\u00e1, Na, Ni, Ni, O, Pa, Pa, Pa, Pe, Pe, Phae, Phle, Plu, Pro, Rha, So, Sty, Ta, Ta, Tha, Ti, Ti, Tu, Xi, Yo, You";

    public static final String FORTRESS_ROOT_SYL_BEGIN_DEFAULT = "a, ba, ba, by, ca, che, chi, chly, cra, cri, ctla, cu, cy, da, de, dhgu, dmu, do, dra, dra, du, f, fl, ga, gae, ge, ku, le, le, li, lj\u00fa, lla, ma, ma, me, mi, na, nd\u00e6, ne, no, ntau, o, o, o, pno, ra, rbe, re, rgo, ri, ri, rka, rm, rna, ro, rphe, rpy, rse, rta, ry, si, si, spe, spho, str\u00f6, ta, the, to, va, yu, "
    ...
    public static final String FORTRESS_SUFFIX_DEFAULT = "Fortress";

    public static final int[] FORTRESS_SYLLABLE_COUNT_WEIGHTS = new int[] { 4, 28, 30, 9, 3 };

    public static final int[] FORTRESS_BLANK_TERMINAL_COUNTS = new int[] { 0, 10, 12, 8, 2 };

    /*
     * Monument name pieces Version 1.8 on
     */
    public static final String MONUMENT_PREFIX_DEFAULT = "Dread, Lost, Odd, Sunken";

    public static final String MONUMENT_ROOT_INITIAL_DEFAULT = "A, A, A, A, A, A, A, A, Aa, Bai, Bi, Bou, Bu, Ca, Ca, Ca, Ca, Can, Co, Cu, Di, Dwa, Ei, Ga, Ge, Ge, Ha, He, He, He, He, Kha, Ki, L, Le, Lo, Lu, Ly, Ma, Ma, Mu, Mu, Na, Na, Ne, Ne, O, O, O, Pa, Pha, Phe, Po, Pu, Quia, R, Ra, Ra, Ra, Rha, Ru, Sa, Sa, Sa, Sae, Shi, Su, Ta, Ta, Tho, Ti, Tu, Y, Ya, Yo";

    public static final String MONUMENT_ROOT_SYL_BEGIN_DEFAULT = "'lye, a, ae, ba, be, che, co, de, du, du, fti, ga, gi, ha, hu, ia, ka, ke, la, lae, le, le, li, li, li, li, lo, ly, mba, mbha, mbu, me, mi, mpto, mu, na, na, na, ncho, ndao, ngho, ni, no, nti, ntre, o, o, po, ra, ra, ra, ra, rde, rga, rka, ro, ro, ro, rpi, rt_Ro, rte, ru, te, ti, ti, ti, tla, tli, ve, ve, vlo, "
    ...
    public static final String MONUMENT_SUFFIX_DEFAULT = "Heart, Mausoleum, Point, Tomb, Tongue";

    public static final int[] MONUMENT_SYLLABLE_COUNT_WEIGHTS = new int[] { 4, 24, 18, 16, 9, 4 };

    public static final int[] MONUMENT_BLANK_TERMINAL_COUNTS = new int[] { 0, 10, 7, 7, 5, 2 };

    /*
     * EndCity name pieces Version 1.9 on
     */
    public static final String END_CITY_PREFIX_DEFAULT = "End, Mag, T\u00edr";

    public static final String END_CITY_ROOT_INITIAL_DEFAULT = "A, A, A, A, Ba, Brah, Ca, Ca, Ce, Ce, Cha, Di, Dy, E, E, E, E, E, Eu, Eu, Ga, Gai, Hau, Hea, Hla, I, I, I, I, I, Ju, Ka, Ko, Lu, Ma, Ma, Ma, Me, Me, Mi, Mi, Moo, N\u00f3, Ne, Ni, O, Pa, Plu, Pu, Rhe, Sa, Sa, Se, Su, Te, Te, Ti, Tla, Tri, U, U, U, U, Va, Ve, Yh, Yo";

    public static final String END_CITY_ROOT_SYL_BEGIN_DEFAULT = "a, a, a, be, bi, cha, da, de, ke, la, la, la, le, le, lha, lli, lo, lo, ltha, lti, ly, ly, ma, ma, mbri, me, mi, mme, na, nce, nde, nga, ni, nnw, nu, ny, o, o, pi, ptu, ra, ra, rco, rcu, re, re, rga, ri, ri, rna, ro, ro, rra, rza, sga, ta, thy, ti, to, to, tu, ve, "
    ...
    public static final String ALIEN_VILLAGE_ROOT_TERMINAL_DEFAULT = "^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, ^, "
    ...
    public static final String ALIEN_VILLAGE_SUFFIX_DEFAULT = "";

    public static final int[] ALIEN_VILLAGE_SYLLABLE_COUNT_WEIGHTS = new int[] { 25, 158, 123, 55, 20, 2 };

    public static final int[] ALIEN_VILLAGE_BLANK_TERMINAL_COUNTS = new int[] { 1, 48, 31, 19, 4, 1 };
    ...
    public static final String CUSTOM_ROOT_INITIAL_DEFAULT = "No";

    public static final String CUSTOM_ROOT_SYL_BEGIN_DEFAULT = "";

    public static final String CUSTOM_ROOT_TERMINAL_DEFAULT = "tch";
    ...
    public static final int[] CUSTOM_BLANK_TERMINAL_COUNTS = new int[] { 0, 0, 0, 0, 0, 0, 0 };
