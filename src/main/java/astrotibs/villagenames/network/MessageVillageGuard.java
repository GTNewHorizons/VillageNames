...
public class MessageVillageGuard implements IMessage {
    ...
    /*
     * public int getProfession() { return this.profession; } public int getCareer() { return this.career; }
     */
    ...
    public String toString() {
        ...
        /*
         * r.append(", Profession = "); r.append(this.getProfession()); r.append(", Career = ");
