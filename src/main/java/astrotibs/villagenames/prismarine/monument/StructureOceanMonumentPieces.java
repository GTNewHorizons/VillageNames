...
public class StructureOceanMonumentPieces
{
    ...
    public static class DoubleXRoom extends StructureOceanMonumentPieces.Piece
        {
            ...
            {
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition = this.roomDefinition.connections[EnumFacing189.EAST.getIndex()];
    ...
    public static class DoubleXYRoom extends StructureOceanMonumentPieces.Piece
        {
			...
			public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition = this.roomDefinition.connections[EnumFacing189.EAST.getIndex()];
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition1 = this.roomDefinition;
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition2 = structureoceanmonumentpieces$roomdefinition1.connections[EnumFacing189.UP.getIndex()];
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition3 = structureoceanmonumentpieces$roomdefinition.connections[EnumFacing189.UP.getIndex()];
    ...
    public static class DoubleYRoom extends StructureOceanMonumentPieces.Piece
        {
			...
			public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition = this.roomDefinition.connections[EnumFacing189.UP.getIndex()];
    ...
    public static class DoubleYZRoom extends StructureOceanMonumentPieces.Piece
        {
			...
			public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition = this.roomDefinition.connections[EnumFacing189.NORTH.getIndex()];
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition1 = this.roomDefinition;
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition2 = structureoceanmonumentpieces$roomdefinition.connections[EnumFacing189.UP.getIndex()];
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition3 = structureoceanmonumentpieces$roomdefinition1.connections[EnumFacing189.UP.getIndex()];
    ...
    static class FitSimpleRoomHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper
        {
            ...
            @Override
			public StructureOceanMonumentPieces.Piece create(EnumFacing189 p_175968_1_, StructureOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
            {
    ...
    public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece
        {
            ...
            private List<StructureOceanMonumentPieces.Piece> childPieces = Lists.<StructureOceanMonumentPieces.Piece>newArrayList(); //field_175843_q in 1.8
            ...
            public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing189 p_i45599_4_)
            {
                ...
                this.childPieces.add(new StructureOceanMonumentPieces.EntryRoom(this.coordBaseMode == -1 ? null : EnumFacing189.getHorizontal(this.coordBaseMode), this.sourceRoom));
                this.childPieces.add(new StructureOceanMonumentPieces.MonumentCoreRoom(this.coordBaseMode == -1 ? null : EnumFacing189.getHorizontal(this.coordBaseMode), this.coreRoom, p_i45599_1_));
                ...
                this.childPieces.add(new StructureOceanMonumentPieces.WingRoom(this.coordBaseMode == -1 ? null : EnumFacing189.getHorizontal(this.coordBaseMode), structureboundingbox1, i++));
                this.childPieces.add(new StructureOceanMonumentPieces.WingRoom(this.coordBaseMode == -1 ? null : EnumFacing189.getHorizontal(this.coordBaseMode), structureboundingbox2, i++));
                this.childPieces.add(new StructureOceanMonumentPieces.Penthouse(this.coordBaseMode == -1 ? null : EnumFacing189.getHorizontal(this.coordBaseMode), structureboundingbox));
            ...
            private List<StructureOceanMonumentPieces.RoomDefinition> func_175836_a(Random p_175836_1_)
            {
                ...
                astructureoceanmonumentpieces$roomdefinition[GRIDROOM_TOP_CONNECT_INDEX].func_175957_a(EnumFacing189.UP, structureoceanmonumentpieces$roomdefinition = new StructureOceanMonumentPieces.RoomDefinition(1003));
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition1;
                astructureoceanmonumentpieces$roomdefinition[GRIDROOM_LEFTWING_CONNECT_INDEX].func_175957_a(EnumFacing189.SOUTH, structureoceanmonumentpieces$roomdefinition1 = new StructureOceanMonumentPieces.RoomDefinition(1001));
                StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition2;
                astructureoceanmonumentpieces$roomdefinition[GRIDROOM_RIGHTWING_CONNECT_INDEX].func_175957_a(EnumFacing189.SOUTH, structureoceanmonumentpieces$roomdefinition2 = new StructureOceanMonumentPieces.RoomDefinition(1002));
    ...
    interface MonumentRoomFitHelper
    {
        ...
        StructureOceanMonumentPieces.Piece create(EnumFacing189 p_175968_1_, StructureOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_); //func_175968_a in 1.8
    }
    ...
    static class RoomDefinition
        {
            ...
            StructureOceanMonumentPieces.RoomDefinition[] connections = new StructureOceanMonumentPieces.RoomDefinition[6]; //field_175965_b in 1.8
    ...
    static class XYDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper
        {
			...
			public boolean fits(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
            {
                ...
                {
                    StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition = p_175969_1_.connections[EnumFacing189.EAST.getIndex()];
    ...
    static class YZDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper
        {
			...
			public boolean fits(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
            {
                ...
                {
                    StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition = p_175969_1_.connections[EnumFacing189.NORTH.getIndex()];
                    return structureoceanmonumentpieces$roomdefinition.hasOpening[EnumFacing189.UP.getIndex()] && !structureoceanmonumentpieces$roomdefinition.connections[EnumFacing189.UP.getIndex()].claimed;
                }
                else
                {
