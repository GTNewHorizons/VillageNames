...
public class StructureOceanMonument extends MapGenStructure {
    ...
    protected static boolean canSpawnStructureAtCoords(World worldIn, int chunkX, int chunkZ) {
        ...
        if (i == k && j == l) // The inputted x and z chunks are the same as the one selected for the monument!
        {
            ...
            /*
             * Determines whether or not the "center" block of the monument is in a Deep Ocean biome. "Center" means the
             * south-east block out of the four central ones. In other words: the north-west-most block of the
             * south-east quadrant of the monument.
             */
    ...
    public static class StartMonument extends StructureStart {
        ...
        /**
         * Keeps iterating Structure Pieces and spawning them until the checks tell it to stop I THINK this is the
         * correct method in 1.7.10...
         */
        @Override
        ...
        /*
         * This function is only in 1.8.9. Returns "true". It is fired during
         * MapGenStructure.generateStructuresInChunk() if (structurestart.isSizeableStructure() &&
         * structurestart.func_175788_a(chunkCoord) && structurestart.getBoundingBox().intersectsWith(i, j, i + 15, j +
         * 15)) The above if condition should be FALSE whenever return this.field_175791_c.contains(pair) and TRUE
         * otherwise I believe this is used to prevent chunks from spawning in places they should not? Not sure.
         */
        ...
        /*
         * This function is only in 1.8.9. Returns nothing. It is fired during
         * MapGenStructure.generateStructuresInChunk() when (structurestart.isSizeableStructure() &&
         * structurestart.getBoundingBox().intersectsWith(k, l, k + 15, l + 15)) == true after
         * structurestart.generateStructure(p_75051_1_, p_75051_2_, new StructureBoundingBox(k, l, k + 15, l + 15)); It
         * is used to compile the chunk coordinates for the 16 chunks involved in the Monument.
         */
