...
public class MobAppearance extends EntityFX {
    ...
    /**
     * Renders the particle This is the version actually called by EffectRenderer.renderLitParticles and
    ...
    /*
     * @SideOnly(Side.CLIENT) public static class Factory implements IParticleFactory { public EntityFX getEntityFX(int
     * particleID, World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn,
     * double zSpeedIn, int... p_178902_15_) { return new MobAppearance(worldIn, xCoordIn, yCoordIn, zCoordIn); } }
     */
}
