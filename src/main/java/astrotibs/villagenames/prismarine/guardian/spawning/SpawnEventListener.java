...
public class SpawnEventListener {
     ...
     * thread: http://www.minecraftforge.net/forum/topic/17547-spawning-a-custom-entity/ which brings EnumHelper to the
     * fore. And to think I was about to abandon that thread as useless.
     */
     ...
     * greater than the spawn cap for type "monster."
     * 
     * Called by WorldServer to gather a list of all possible entities that can spawn at the specified location. If an
     * entry is added to the list, it needs to be a globally unique instance. The event is called in
     * WorldServer#spawnRandomCreature(EnumCreatureType, int, int, int) Canceling the event will result in a empty list,
     * meaning no entity will be spawned.
     */
    ...
    /**
     * This method triggers when the Overworld is loaded. It then attempts to retrogen Elder Guardians into Ocean
     * Monuments that were spawned before the 3.0 update.
     * 
    ...
    /**
     * Inputs WorldEvent.PotentialSpawns event, and determines whether the x, y, z in that event falls within the
     * bounding box of ANY generated Monument structure
     */
    ...
    /**
     * Made to tally the Guardians against the monster mobs Copied pretty much wholesale from
     * net.minecraft.world.SpawnerAnimals adds all chunks within the spawn radius of the players to
     * eligibleChunksForSpawning. pars: the world, hostileCreatures, passiveCreatures. returns number of eligible
     * chunks.
     */
