    ...
    public void onEntityInteract(EntityInteractEvent event) {
        ...
        if (Loader.isModLoaded("witchery") && event.entity instanceof EntityPlayer
            ...
            String targetClassPath = event.target.getClass()
                .toString()
                .substring(6); // The classpath string of the target
                        ...
                        if (playerRep < 0) { // Your reputation is too low.
                            ...
                            // If the item in your hand is a gold ingot, trade both gold ingots and emeralds.
                                ...
                                if ((emeralds >= emeraldRequired && goldIngots >= goldRequired)
                                    || player.capabilities.isCreativeMode) { // Allow Creative players to get Codexes
                                                                             // regardless of emerald/gold count
                            ...
                            // If the item in your hand is an iron ingot, trade both iron ingots and emeralds.
                                ...
                                if ((emeralds >= emeraldRequired && ironIngots >= ironRequired)
                                    || player.capabilities.isCreativeMode) { // Allow Creative players to get Codexes
                                                                             // regardless of emerald/iron count
                                ...
                                if (playerRep < 0) { // Your reputation is too low.
                                    ...
                                    while (itr.hasNext()) { // Going through the list of VN villages
                                        ...
                                        if (villageNearSign == villageNearTarget) { // There is a match between the
                                                                                    // nearest village to this villager
                                                                                    // and the nearest village to the
                                                                                    // sign
                                            signLocated = true;
                                            if (!world.isRemote) {
                                    ...
                                    if (!signLocated) {
                                        ...
                                        // We can assume this is a village WITHOUT a sign. So let's at least give it a
                                        // name!
                                        ...
                                        nbttagcompound1.setInteger("townColor", townColorMeta); // In case we want to
                                                                                                // make clay, carpet,
                                                                                                // wool, glass, etc
                                        ...
                                        nbttagcompound1.setBoolean("fromEntity", true); // Record whether this name was
                                                                                        // generated from interaction
                                                                                        // with an entity

                                        if (player.dimension == 0 && // Added to avoid a crash by loading a null list of
                                                                     // villages
                                        !ReputationHandler.getVillageTagPlayerIsIn((EntityPlayerMP) player)
                                            .equals("none")) {
                                            nbttagcompound1.setBoolean("preVN", true); // No Village Names entry was
                                                                                       // discovered, so presumably this
                                                                                       // village was generated before
                                                                                       // including VN
                                        } else {
                                        ...
                                        // If you don't have a mod banner, this will not be added. It will be generated
                                        // once you do.
                                    ...
                                    if (nbtbase.getId() == 10) { // 10 is "compound tag" I think?
                                        ...
                                        try {
                                            ...
                                            if (targetX >= boundingBox[0] && targetY >= boundingBox[1]
                                                ...
                                                && targetZ <= boundingBox[5]) { // Target is inside bounding box.
                                                ...
                                                // If none is found, these strings are "null" which parseInt does not
                                                // like very much
                                                try {
                                                ...
                                                // If a name was NOT returned, then we need to generate a new one, as is
                                                // done below:
                                                ...
                                                if (structureInfoArray[0] == null && structureInfoArray[1] == null
                                                    ...
                                                    structureInfoArray = NameGenerator
                                                        .newRandomName(nameType, deterministic); // Generates name based
                                                                                                 // on table above
                                                    ...
                                                    nbttagcompound1.setInteger("townColor", townColorMeta); // In case
                                                                                                            // we want
                                                                                                            // to make
                                                                                                            // clay,
                                                                                                            // carpet,
                                                    ...
                                                    nbttagcompound1.setString("nameRoot", nameRoot);
                                                    nbttagcompound1.setString("nameSuffix", nameSuffix);
                                                    nbttagcompound1.setBoolean("fromEntity", true); // Record whether
                                                                                                    // this name was
                                                                                                    // generated from
                                                                                                    // interaction with
                                                                                                    // an entity
                                                ...
                                                // Either the structure name already existed, or it was just generated
                                                // right above.
                                                ...
                                                // I don't care if the structure has a sign. We have to cut the name up
                                                // into arbitrary sign strings for the book.
                                                ...
                                                if (!world.isRemote) {
                                                    WriteBookHandler.targetWriteNewVillageBook(
                                                        ...
                                                        event,
                                                        targetProfession,
                                                        targetCareer, // Also unused but there's no harm in leaving them
                                                        -1,
                                                        -1, // Trade size and player rep are unused outside of vanilla
                                                            // villages
                                                        player,
                                                        target);
                                                }
                                            ...
                                            // There's a tag like [23,-3] (chunk location) but there's no bounding box
                                            // tag. Not a good sign, bruv.
                                            if (GeneralConfig.debugMessages && !world.isRemote) {
                ...
                if (GeneralConfig.nameEntities && GeneralConfig.modNameMappingClickable_map.get("ClassPaths")
                    ...
                    if ((customName.trim()).equals("") || customName.equals(null)
                        || (targetClassPath.equals("net.daveyx0.primitivemobs.entity.passive.EntityTravelingMerchant")
                            && (customName.equals(PMTMUnloc) || customName.equals(PMTMUnlocModern))// Contingency in
                                                                                                   // there specifically
                                                                                                   // for PM's Traveling
                                                                                                   // Merchants
                    )
                        || (targetClassPath.equals("net.daveyx0.primitivemobs.entity.passive.EntitySheepman")
                            && (customName.equals(PMShUnloc) || customName.equals(PMShUnlocModern)) // Contingency in
                                                                                                    // there
                                                                                                    // specifically for
                                                                                                    // PM's Sheepman
                        ...
                        || (targetClassPath.equals("net.daveyx0.primitivemobs.entity.passive.EntitySheepmanSmith")
                            && (customName.equals(PMSSUnloc)) // Contingency in there specifically for PM's Sheepman
                                                              // Smith
                    ...
                    // Clickable Entity already has a name. You may want to add (or remove) a career tag.
                        ...
                        && (!(target instanceof EntityVillager) || targetAge >= 0)) { // Target is named but does not
                                                                                      // have job tag: add one!
                ...
                try {
                    ...
                    if (playerRep <= -30 // Town rep is minimum
                        && !playerMP.func_147099_x()
                            .hasAchievementUnlocked(VillageNames.minrep) // Copied over from EntityPlayerMP
                    ) {
