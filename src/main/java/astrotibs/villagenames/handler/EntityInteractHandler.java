...
public class EntityInteractHandler {
        ...
        if (!event.world.isRemote && event.action == Action.RIGHT_CLICK_BLOCK && GeneralConfig.debugMessages) {
            ...
            event.entityPlayer.addChatComponentMessage(
                new ChatComponentText(
                    "Class path of this block: " + targetBlock.getClass()
                        .toString()
                        .substring(6)));
            event.entityPlayer
    ...
    public void onEntityInteract(EntityInteractEvent event) {
        ...
        if (Loader.isModLoaded("witchery") && event.entity instanceof EntityPlayer
            ...
            && ((EntityPlayer) event.entity).inventory.getCurrentItem()
            ...
            String targetClassPath = event.target.getClass()
                .toString()
                .substring(6); // The classpath string of the
                               // target
            ...
            if (!world.isRemote && GeneralConfig.debugMessages) {
                        ...
                        LogHelper.info(
                            "Profession: " + targetProfession
                                ...
                                + (GeneralConfig.modernVillagerSkins
                                    ? ", BiomeType: " + (ExtendedVillager.get((EntityVillager) target)).getBiomeType()
                                    : "")
                                + (GeneralConfig.modernVillagerSkins
                                    ? ", Profession Level: "
                                ...
                                + (GeneralConfig.villagerSkinTones
                                    ? ", Skin Tone: " + (ExtendedVillager.get((EntityVillager) target)).getSkinTone()
                                    : ""));
                    ...
                    try {
                        LogHelper.info(
                            (GeneralConfig.modernZombieSkins
                                ...
                                + (GeneralConfig.modernZombieSkins
                                    ? ", BiomeType: "
                                        + (ExtendedZombieVillager.get((EntityZombie) target)).getBiomeType()
                                    : "")
                                + (GeneralConfig.modernZombieSkins
                                    ? ", Profession Level: "
                                        + (ExtendedZombieVillager.get((EntityZombie) target)).getProfessionLevel()
                                    : "")
                                + (GeneralConfig.villagerSkinTones
                                    ? ", Skin Tone: "
                ...
                LogHelper.info(
                    "Entity CustomName: " + (customName.equals("") || customName.equals(null) ? "(None)" : customName)
                        + ", Age: "
                        + targetAge
            ...
            if (itemstack != null && itemstack.getItem() == Items.name_tag) {
                ...
                if (itemstack.hasDisplayName() && !itemstack.getDisplayName()
                    .equals(customName)) {
                 ...
                 */
                try {
                    if (!world.isRemote && (GeneralConfig.entitiesNameableLikePets_set.contains(
                        target.getClass()
                            .toString()
                            .substring(6))
                        ...
                        && (!itemstack.hasDisplayName() || (itemstack.hasDisplayName() && itemstack.getDisplayName()
                            .equals("")))) {
                        event.setCanceled(true);
            ...
            // -------------------------------//
                ...
                if ((population == 0 || (playerIsInVillage && population == -1)) // No Villagers in the village
                    ...
                    if (!((EntityPlayerMP) player).func_147099_x()
                        .hasAchievementUnlocked(VillageNames.laputa)) {
                ...
                if (targetAge < 0) {
                    ...
                    if (villageNearTarget != null) { // The Villager is inside/near a village
                        ...
                        if (playerRep < 0) { // Your reputation is too low.
                            if (!world.isRemote) {
                                player
                                    .addChatComponentMessage(new ChatComponentText("The villager does not trust you."));
                            }
                        } else {
            ...
            // If you're holding a book...
                ...
                && GeneralConfig.villagerMakesBook) {
                    ...
                    if (target instanceof EntityVillager) {
                                ...
                                if (playerRep < 0) { // Your reputation is too low.
                                    ...
                                    if (!signLocated) {
                                        ...
                                        deterministic.setSeed(
                                            world.getSeed()
                                                + FunctionsVN.getUniqueLongForXYZ(centerX, centerY, centerZ));
                                        String[] newVillageName = NameGenerator.newRandomName(
                                            player.dimension == -1 ? "Village-Fortress"
                                                : player.dimension == 1 ? "Village-EndCity" : "Village",
                                            deterministic);
                        ...
                        try {
                            structureType = (String) (GeneralConfig.modStructureNames_map.get("StructureTypes")).get(
                                GeneralConfig.modStructureNames_map.get("ClassPaths")
                                    .indexOf(targetClassPath));
                        } catch (Exception e) {
                            structureType = "";
                        ...
                        try {
                            structureTitle = (String) (GeneralConfig.modStructureNames_map.get("StructureTitles")).get(
                                GeneralConfig.modStructureNames_map.get("ClassPaths")
                                    .indexOf(targetClassPath));
                        } catch (Exception e) {}
                        ...
                        try {
                            dimensionName = (String) (GeneralConfig.modStructureNames_map.get("DimensionNames")).get(
                                GeneralConfig.modStructureNames_map.get("ClassPaths")
                                    .indexOf(targetClassPath));
                        } catch (Exception e) {}
            ...
            // entry from the config list.
                ...
                if (GeneralConfig.nameEntities && GeneralConfig.modNameMappingClickable_map.get("ClassPaths")
                    .contains(targetClassPath)) {
                    ...
                    // Clickable Entity already has a name. You may want to add (or remove) a career tag.
                        ...
                        && (!(target instanceof EntityVillager) || targetAge >= 0)) { // Target is named but does
                            ...
                            // Apply the name
                            target.setCustomNameTag(newCustomName.trim());
                        } else if (customName.indexOf("(") != -1 && !GeneralConfig.addJobToName) { // Target has a job
                                                                                                   // tag:
                                                                                                   // remove it...
                            target.setCustomNameTag(
                                customName.substring(0, customName.indexOf("("))
                                    .trim());
                        }
                }
                // Entity is a custom automatic config entry.
                else if (GeneralConfig.nameEntities && GeneralConfig.modNameMappingAutomatic_map.get("ClassPaths")
                    .contains(targetClassPath)) {
                        if (((customName.trim()).equals("") || customName.equals(null))
                            && !((String) ((GeneralConfig.modNameMappingAutomatic_map.get("AddOrRemove")).get(
                                GeneralConfig.modNameMappingAutomatic_map.get("ClassPaths")
                                    .indexOf(targetClassPath)))).trim()
                                        .equals("remove")) {
                            ...
                            try {
                                ...
                                mappedNameType = (String) ((GeneralConfig.modNameMappingAutomatic_map.get("NameTypes"))
                                    .get(
                                        GeneralConfig.modNameMappingAutomatic_map.get("ClassPaths")
                                            .indexOf(targetClassPath)));
                            } catch (Exception e) { // Your config file was poorly formatted
                    ...
                    && ((customName.trim()).equals("") || customName.equals(null))) {
                        ...
                        if (targetPlayerCreated) {
                            ...
                            if (!world.isRemote) player
                                .addChatComponentMessage(new ChatComponentText("You can give this golem a name tag!"));
                        } else {
                            ...
                            if (villageNearGolem != null) { // The golem is in/near a village
                                if ((customName.trim()).equals("") || customName.equals(null)) {
                                    if (villageNearGolem.getNumVillagers() > 0) {
                                        ...
                                        player.addChatComponentMessage(
                                            new ChatComponentText("There is nobody left to tell you its name."));
                                    }
                                }
            ...
            if (event.target instanceof EntityVillager || event.target instanceof EntityIronGolem
                ...
                try {
                    ...
                    if (playerRep <= -30 // Town rep is minimum
                        && !playerMP.func_147099_x()
                            .hasAchievementUnlocked(VillageNames.minrep) // Copied over from
                                                                         // EntityPlayerMP
                    ) {
    ...
    public static void villagerConfused(EntityPlayer player) {
        ...
        if (!player.worldObj.isRemote) player.addChatComponentMessage(
            new ChatComponentText(
                messagetype
                    ? "The villager seems " + cantHelpAdjective.get(new Random().nextInt(cantHelpAdjective.size()))
                        + ", and glances around."
