    ...
    public void onEntityJoinWorld(EntityJoinWorldEvent event) {
        ...
        // New entity is a villager. Check to see if it came into being via a cured villager-zombie.
            ...
            if (event.world.isRemote) {
                ...
                /*
                 * // Try to assign a biome number if this villager has none. if ( ev != null //&&
                 * villager.getProfession() >=0 //&& villager.getProfession() <=5 &&
                 ...
                 * ; } // Try to assign a skin tone number if this villager has none. if ( ev != null &&
            ...
            && (EventType.GUARD).getTracker()
                .size() > 0) {
                    ...
                    if (event.entity.worldObj.isRemote) {
                        ...
                        /*
                         * else { if (GeneralConfigHandler.debugMessages) { LogHelper.
