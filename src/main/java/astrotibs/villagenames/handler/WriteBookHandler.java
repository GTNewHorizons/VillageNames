...
public class WriteBookHandler {
    ...
    /**
     * This method is fired when a player right clicks a regular book onto a Villager or modded village inhabitant. It
     * consumes the book and returns the new Village Book.
     * 
     * @param bookType          - String referring to which type of book to drop. e.g. "village", "MoonVillage", etc
     * @param author            - Either the name of the target that's writing the book, or your own name if using a
     *                          Codex
     * @param locX,             locY, locZ - The location of a village's sign, or otherwise the midpoint of the
     ...
     * @param playerIsInVillage - whether or not you're in a village bounding box. Checked against villageYouAreIn below
     *                          to trigger Ghost Town achievement.
     ...
     * @param targetProfession, targetCareer - The integers representing profession and career: used to write a second
     *                          page
    ...
    public static void targetWriteNewVillageBook(String bookType, String author, int locX, int locY, int locZ,
        ...
        } // By default, or if the type was misspelled, use a Village book.
        ...
        book.stackTagCompound.setString("title", (namePrefix + " " + nameRoot + " " + nameSuffix).trim()); // Set the
                                                                                                           // title
        // Set the author
    ...
    /**
     * This method calls the version above, but with dummy values inserted to guarantee that there will be no second
     * "hint" page.
     */
    ...
    public static String makeSecondPage(EntityInteractEvent event, String targetClassPath, Village villageNearVillager,
        ...
        double maxStructureDistance = playerRep * Math.sqrt(villagerTradeCount + 1) * radiusCoef; // Maximum radius
                                                                                                  // villager is allowed
                                                                                                  // to report a
                                                                                                  // structure
        ...
        // Initialize these as empty and assign values later as needed. Results in improved performance, especially with
        ...
        switch (villagerMappedProfession) {
            ...
            case 2: // Villager is a Priest. Find a temple.
                ...
                if (villagerCareer == 0 && !GeneralConfig.villagerCareers // If the priest's career is 0--only plausible
                    ...
                    if (templeDistSq <= maxStructureDistance * maxStructureDistance && templeDistSq < monumentDistSq) {
            ...
            case 4: // Villager is a Butcher. Find a temple or a village.
                ...
                if (villageDistSq <= maxStructureDistance * maxStructureDistance && villageDistSq < templeDistSq) {
                    ...
                    if (templeDistSq <= maxStructureDistance * maxStructureDistance && templeDistSq <= villageDistSq) {
                        // Only a Temple has been legally detected. Report that.
                        closestStructure = "Temple";
                        closestCoords = nearestTempleXYZ;
                    }
    ...
    /**
     * Used to find the nearest structure to the target entity by structure name. Returns [0,0,0] if none found. You can
    ...
    private static String writeStructureHintPage(String nearbyStructure, int[] structureCoords, int villagerProfession,
        ...
        if (structureNameArray[0] == null && structureNameArray[1] == null && structureNameArray[2] == null) {
            ...
            nbttagcompound1.setInteger("townColor", townColorMeta); // In case we want to make clay, carpet, wool,
                                                                    // glass, etc
        ...
        int approxDist2D = (int) Math.round(featureDistance2D / 100) * 100; // Approximates the distance to the
                                                                            // structure
        ...
        if (isInVillageBounds && isBelowGround) {
            ...
            if (approxDist2D >= 100) {
                ...
                String[] approxStringArray = new String[] { "approximately", "roughly", "about" };
                ...
                String[] approxStringArray = new String[] { "less than", "under", "short of" };
                String approxString = approxStringArray[random.nextInt(approxStringArray.length)];
    ...
    private static String[] tryGetStructureName(String nearbyStructure, int[] structureCoords,
        ...
        while (itr.hasNext()) {
            ...
            double sdy = (featureY == 64) ? 0.d : featureY - structureCoords[1]; // A signY of 64 likely means it was
                                                                                 // detected pre-generation.
