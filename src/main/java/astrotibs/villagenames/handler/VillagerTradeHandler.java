                    ...
                    case 2: // Fisherman
                        ...
                        if (GeneralConfig.modernVillagerTrades) {
                                        ...
                                        recipeList.add(
                                            new MerchantRecipe(
                                                new ItemStack(
                                                    ...
                                                    3),
                                                new ItemStack(Items.emerald, 1),
                                                new ItemStack(Items.emerald, 2))); // Added a dud trade so that it will
                                                                                   // appear on the buying list
                                    }
                                } else {
                            ...
                            if (nextSlotToFill >= 2) {
                                recipeList.addToListWithCheck(
                                    new MerchantRecipe(
                                        new ItemStack(Items.emerald, 7 + random.nextInt(2)), // Enchanted fishing rod
                                        EnchantmentHelper.addRandomEnchantment(
                                            random,
                                            new ItemStack(Items.fishing_rod, 1),
                                            5 + random.nextInt(15))));
                        ...
                        if (GeneralConfig.modernVillagerTrades) {
                            ...
                            if (nextSlotToFill == 3 || nextSlotToFill > 4) {
                                recipeList.addToListWithCheck(
                                    new MerchantRecipe(
                                        new ItemStack(Items.emerald, 1),
                                        new ItemStack(Items.ender_pearl, 4 + random.nextInt(4)))); // Lapis Lazuli
                            }
                        }
                        ...
                        if (GeneralConfig.modernVillagerTrades) {
                            ...
                            if (nextSlotToFill == 3) {
                                for (int i = 0; i < 2; i++) {
                                     ...
                                     * nextSlotToFill, 3) ),
                                     * EnchantmentHelper.addRandomEnchantment(random, new ItemStack(Items.diamond_hoe,
                                     * 1), enchantvalue ) ) );
                                     */
                                }
                        ...
                        if (GeneralConfig.modernVillagerTrades) {
                            ...
                            if (nextSlotToFill >= 2) {
                                recipeList.addToListWithCheck(
                                    new MerchantRecipe(
                                        new ItemStack(Items.emerald, 1),
                                        new ItemStack(Items.cooked_chicken, 6 + random.nextInt(3)))); // Lapis Lazuli
                            }
                        }
                    ...
                    case 2: // Leatherworker
                        ...
                        if (GeneralConfig.modernVillagerTrades) {
                                ...
                                for (int i = 0; i < 2; i++) {
                                    ...
                                    recipeList.add(
                                        new MerchantRecipe(
                                            ...
                                            new ItemStack(Items.emerald, 1), // Second emerald to distinguish this from
                                                                             // the other tunic trade
                                            EnchantmentHelper
                            ...
                            if (nextSlotToFill == 2 || nextSlotToFill > 3) {
                                recipeList.addToListWithCheck(
                                    new MerchantRecipe(
                                        new ItemStack(Items.emerald, 7 + random.nextInt(2)), // Enchanted leather tunic
                                        EnchantmentHelper.addRandomEnchantment(
                                            random,
