...
public class ChestLootHandler {
    ...
    // These values are defaults for loot population: they are assumed when not explicitly listed in the 1.14+ json loot
    // tables.
    private static final int DEFAULT_LOOT_STACK_MINIMUM = 1, DEFAULT_LOOT_STACK_MAXIMUM = 1,
        DEFAULT_LOOT_STACK_WEIGHT = 1;

    private static final Object[][] ARMORER_CHEST_LOOT_ARRAY = new Object[][] {
        { new ItemStack(Items.iron_ingot), 1, 3, 2 }, { new ItemStack(Items.bread), 1, 4, 4 },
        { new ItemStack(Items.iron_helmet), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
            DEFAULT_LOOT_STACK_WEIGHT },
        { new ItemStack(Items.emerald), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
            DEFAULT_LOOT_STACK_WEIGHT }, },
        TOOLSMITHY_CHEST_LOOT_ARRAY = new Object[][] {
            ...
            { new ItemStack(Items.coal), 1, 3, DEFAULT_LOOT_STACK_WEIGHT }, { new ItemStack(Items.stick), 1, 3, 20 },
        ...
        // {new ItemStack(Items.iron_horse_armor), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
        // DEFAULT_LOOT_STACK_WEIGHT},
        // {new ItemStack(Items.golden_horse_armor), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
        // DEFAULT_LOOT_STACK_WEIGHT},
        // {new ItemStack(Items.diamond_horse_armor), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
        // DEFAULT_LOOT_STACK_WEIGHT},
        };
    ...
    public static void init() {
        ...
        // Village blacksmiths
        ChestGenHooks
            .addItem("villageBlacksmith", new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 3));

        // Mineshafts
        ChestGenHooks
            .addItem("mineshaftCorridor", new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 2));

        // Temples
        ChestGenHooks
            .addItem("pyramidDesertyChest", new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 12));
        ChestGenHooks
            .addItem("pyramidJungleChest", new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 10));

        // Strongholds
        ChestGenHooks
            .addItem("strongholdCorridor", new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 4));
        ChestGenHooks
            .addItem("strongholdCrossing", new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 15));
        ChestGenHooks
            .addItem("strongholdLibrary", new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 3, 20));

        // Other mods
        if (Loader.isModLoaded("Mariculture")) ChestGenHooks
            .addItem("oceanFloorChest", new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 20)); // Mariculture
        if (Loader.isModLoaded("Artifacts")) ChestGenHooks
            .addItem("A_WIZARD_DID_IT", new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 4, 20)); // Dragon
                                                                                                                  // Artifacts

        // Modern village buildings
        if (VillageGeneratorConfigHandler.newVillageGenerator) {
            ChestGenHooks.addItem(
                Reference.VN_CARTOGRAPHER,
                new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 2, 4));
            ChestGenHooks
                .addItem(Reference.VN_LIBRARY, new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 2, 4));
            ChestGenHooks
                .addItem(Reference.VN_MASON, new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 1));
            ChestGenHooks.addItem(
                Reference.VN_TOOLSMITH,
                new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 3));
        }
    }
    ...
    public static void iglooChest() {
        ...
        if (GeneralConfig.codexChestLoot)
            iglooChestContents.addItem(new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 8));
    ...
    public static void modernVillageChests() {
        ...
        chestGenHooks.setMin(stacks_min);
        chestGenHooks.setMax(stacks_max + 1);

        // Register chest entries: ItemStack, stackMin, stackMax, weight
        for (Object[] chestItemObject : new Object[][] {
            { new ItemStack(Items.clay_ball), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.dye, 1, 2), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Blocks.cactus), 1, 4, 10 }, { new ItemStack(Items.wheat), 1, 7, 10 },
            { new ItemStack(Items.bread), 1, 4, 10 },
            { new ItemStack(Items.book), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Blocks.deadbush), 1, 3, 2 },
            { new ItemStack(Items.emerald), 1, 3, DEFAULT_LOOT_STACK_WEIGHT }, }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
                    new WeightedRandomChestContent(
                        (ItemStack) chestItemObject[0],
                        (Integer) chestItemObject[1],
                        (Integer) chestItemObject[2],
                        (Integer) chestItemObject[3]));
            }
        }
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { new ItemStack(Blocks.red_flower), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.potato), 1, 7, 10 }, { new ItemStack(Items.bread), 1, 4, 10 },
            { new ItemStack(Items.apple), 1, 5, 10 },
            { new ItemStack(Items.book), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.feather), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.emerald), 1, 4, 2 }, { new ItemStack(Blocks.sapling), 1, 2, 5 }, // Oak sapling
        }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
                    new WeightedRandomChestContent(
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { new ItemStack(Blocks.double_plant, 1, 2), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM, 5 }, // Tall
                                                                                                                     // grass
            { new ItemStack(Items.bread), 1, 4, 10 }, { new ItemStack(Items.wheat_seeds), 1, 5, 10 },
            { new ItemStack(Items.emerald), 1, 4, 2 }, { new ItemStack(Blocks.sapling, 1, 4), 1, 2, 10 }, // Acacia
            { new ItemStack(Items.saddle), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Blocks.torch), 1, 2, DEFAULT_LOOT_STACK_WEIGHT }, { new ItemStack(Items.bucket),
                DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM, DEFAULT_LOOT_STACK_WEIGHT }, }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
                    new WeightedRandomChestContent(
                        (ItemStack) chestItemObject[0],
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { ModObjects.chooseModBeetrootSoup(), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Blocks.furnace), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.emerald), 1, 4, DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.snowball), 1, 7, 10 }, { new ItemStack(Items.coal), 1, 4, 5 }, }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
                    new WeightedRandomChestContent(
                        (ItemStack) chestItemObject[0],
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { new ItemStack(Blocks.double_plant, 1, 3), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM, 2 }, // Large
                                                                                                                     // Fern
            { new ItemStack(Items.potato), 1, 7, 10 },
            { sweetBerries == null ? null : new ItemStack(sweetBerries), 1, 7, 5 },
            { new ItemStack(Items.bread), 1, 4, 10 }, { new ItemStack(Items.pumpkin_seeds), 1, 5, 5 },
            { new ItemStack(Items.pumpkin_pie), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.emerald), 1, 4, 2 }, { new ItemStack(Blocks.sapling, 1, 1), 1, 5, 5 }, // Spruce
                                                                                                         // Sapling
            { ModObjects.chooseModWoodenSignItem(1), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT }, // Spruce Sign
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { ModObjects.chooseModWoodenSignItem(3), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT }, // Jungle Sign
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { new ItemStack(Items.fish, 1, 0), DEFAULT_LOOT_STACK_MINIMUM, 2, DEFAULT_LOOT_STACK_WEIGHT }, // Raw
                                                                                                           // Cod
            { new ItemStack(Blocks.fence), DEFAULT_LOOT_STACK_MINIMUM, 4, 2 }, // Oak Fence
            { new ItemStack(Items.boat), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT }, // Oak Boat
            { ModObjects.chooseModPrismarineShardItemStack(), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT }, }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
                    new WeightedRandomChestContent(
        ...
        for (Object[] chestItemObject : new Object[][] {
            { new ItemStack(Items.emerald), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.porkchop), 1, 3, 6 }, { new ItemStack(Items.wheat), 1, 3, 6 },
            { new ItemStack(Items.beef), 1, 3, 6 }, { ModObjects.chooseModRawMutton(), 1, 3, 6 },
        ...
        // Register chest entries: ItemStack, stackMin, stackMax, weight
        for (Object[] chestItemObject : new Object[][] { { new ItemStack(Items.map), 1, 3, 10 },
            { new ItemStack(Items.paper), 1, 5, 15 },
            { new ItemStack(Items.compass), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM, 5 },
            { new ItemStack(Items.bread), 1, 4, 15 }, { new ItemStack(Items.stick), 1, 2, 5 }, }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
                    new WeightedRandomChestContent(
                        (ItemStack) chestItemObject[0],
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { new ItemStack(Items.bucket), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT }, }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
                    new WeightedRandomChestContent(
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { new ItemStack(Items.clay_ball), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.wheat_seeds), 1, 3, 3 }, { new ItemStack(Items.coal), 1, 3, 2 }, }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
                    new WeightedRandomChestContent(
                        (ItemStack) chestItemObject[0],
        ...
        for (Object[] chestItemObject : new Object[][] {
            { new ItemStack(Items.emerald), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.arrow), 1, 3, 2 }, { new ItemStack(Items.feather), 1, 3, 6 },
            { new ItemStack(Items.egg), 1, 3, 2 }, { new ItemStack(Items.flint), 1, 3, 6 },
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { new ItemStack(Items.writable_book), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            ...
            { new ItemStack(Items.emerald), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { dustyBook_LB == null ? null : new ItemStack(dustyBook_LB), DEFAULT_LOOT_STACK_MINIMUM,
                DEFAULT_LOOT_STACK_MAXIMUM, 2 }, // Lost Book
        }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
                    new WeightedRandomChestContent(
        ...
        for (Object[] chestItemObject : new Object[][] {
            ...
            { new ItemStack(Items.flower_pot), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            ...
            { new ItemStack(Items.dye, 1, 11), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT }, // Dandelion Yellow
            { new ItemStack(
                (Block) ModObjects.chooseModSmoothStoneBlockObject()[0],
                1,
                (Integer) ModObjects.chooseModSmoothStoneBlockObject()[1]), DEFAULT_LOOT_STACK_MINIMUM,
                DEFAULT_LOOT_STACK_MAXIMUM, DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.emerald), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT }, }) {
            if (chestItemObject[0] != null) {
                chestGenHooks.addItem(
        ...
        // Register chest entries: ItemStack, stackMin, stackMax, weight
        for (Object[] chestItemObject : new Object[][] { { new ItemStack(Blocks.wool, 1, 0), 1, 8, 6 }, // White
            ...
            { new ItemStack(Items.emerald), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
            { new ItemStack(Items.shears), DEFAULT_LOOT_STACK_MINIMUM, DEFAULT_LOOT_STACK_MAXIMUM,
                DEFAULT_LOOT_STACK_WEIGHT },
        ...
        // Register chest entries: ItemStack, stackMin, stackMax, weight
        for (Object[] chestItemObject : new Object[][] { { new ItemStack(Items.redstone), 1, 4, 2 },
            { new ItemStack(Items.bread), 1, 4, 7 }, { new ItemStack(Items.rotten_flesh), 1, 4, 7 },
