...
public class ChestLootHandler {
    ...
    public static void init() {
        ...
        ChestGenHooks.addItem(
                "pyramidDesertyChest",
                new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 12));
        ChestGenHooks
        ...
        if (VillageGeneratorConfigHandler.newVillageGenerator) {
            ...
            ChestGenHooks.addItem(
                    Reference.VN_LIBRARY,
                    new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 2, 4));
            ChestGenHooks.addItem(
                    Reference.VN_MASON,
                    new WeightedRandomChestContent(new ItemStack(ModItems.codex), 1, 1, 1));
            ChestGenHooks.addItem(
    ...
    public static void modernVillageChests() {
        ...
        for (Object[] chestItemObject : new Object[][] {
                ...
                { ModObjects.chooseModPrismarineShardItemStack(), DEFAULT_LOOT_STACK_MINIMUM,
