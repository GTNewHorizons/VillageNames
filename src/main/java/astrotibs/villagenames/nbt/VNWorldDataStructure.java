...
public class VNWorldDataStructure extends WorldSavedData implements VNWorldData {
    ...
    /*
     * STRUCTURE key toptag Villages: villagenames Villages Temples: villagenames_te Temples Mineshafts: villagenames_mi
     * Mineshafts Strongholds: villagenames_st Strongholds Monuments: villagenames_mo Monuments Mansions:
     * villagenames_ma Mansions Fortress: villagenames_fo Fortresses End City: villagenames_ec EndCities Abandoned Base:
     * villagenames_gcab AbandonedBases End Islands: villagenames_heei hardcoreenderdragon_EndIsland End Towers:
     * villagenames_heet hardcoreenderdragon_EndTower Fronos Villages: villagenames_mpfv FronosVillages Koentus Vill:
     * villagenames_mpkv KoentusVillages Moon Villages: villagenames_gcmv MoonVillages Nibiru Villages:
     * villagenames_mpnv NibiruVillages
     */
