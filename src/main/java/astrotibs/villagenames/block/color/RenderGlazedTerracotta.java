...
public class RenderGlazedTerracotta implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        renderer.uvRotateEast = orient < 2 ? 1 - orient : orient; // Rotate north-facing side (N&S orientations are
                                                                  // flipped)
        renderer.uvRotateSouth = orient > 1 ? 2 * orient - 4 : 3 - 2 * orient; // Rotate east-facing side (E&W
