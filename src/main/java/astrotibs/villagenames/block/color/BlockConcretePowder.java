...
public class BlockConcretePowder extends BlockFalling {
    ...
    public void func_149830_m(World world, int x, int y, int z) {
        if (func_149831_e(world, x, y - 1, z) && y >= 0) // True if block underneath is air, fire, water, or lava
        {
            ...
            if (!fallInstantly && world.checkChunksExist(x - b0, y - b0, z - b0, x + b0, y + b0, z + b0)) // Checks if
                                                                                                          // surrounding
                                                                                                          // chunks
                                                                                                          // exist
    ...
    /**
     * 1.7.10 Lets the block know when one of its neighbor changes. Doesn't know which neighbor changed (coordinates
     * passed are their own) Args: x, y, z, neighbor Block
     */
    @Override
    ...
    /**
     * 1.7.10 Called whenever the block is added into the world. Args: world, x, y, z
     */
    @Override
