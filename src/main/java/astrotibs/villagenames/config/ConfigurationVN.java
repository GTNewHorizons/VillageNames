...
/**
 * Adaptation of get methods without the default values being printed in the comments, to save from loading up the
 * config file with too much distracting text.
 */
