...
public class VillageGeneratorConfigHandler {
    ...
    public static int componentModernPlainsFountain, componentModernPlainsWell, componentModernPlainsMarket,
        ...
        componentModernDesertMarket, componentModernTaigaSquare, componentModernTaigaWell, componentModernSavannaMarket,
        componentModernSavannaFountain, componentModernSavannaDoubleWell, componentModernSavannaWell,
        componentModernSnowyIceSpire, componentModernSnowyFountain, componentModernSnowyPavilion,
        componentModernJungleStatue, componentModernJungleCocoaTree, componentModernJungleGarden,
        componentModernJungleVilla, componentModernSwampWillow, componentModernSwampStatue,
        componentModernSwampPavilion, componentModernSwampMonolith;
    ...
    public static void loadConfiguration() {
        ...
        for (int i = 1; i < modernDefaults.size(); i++) {
            modifiedDefaults
                .set(i, modernDefaults.get(i) * savannaHouses * savannaStreetToHouseRatio / savannaStreetsAndEndcaps);
        }
        ...
        spawnBiomesNames = config.getStringListWithoutDefaultsInComment(
            ...
            new String[] {
                ...
                "Sunflower Plains", "Desert M", "Flower Forest", "Jungle Edge", "Birch Forest M", "Mega Spruce Taiga",
                // Biomes o' Plenty
                "Bamboo Forest", "Bayou", "Bog", "Boreal Forest", "Chaparral", "Cherry Blossom Grove",
                "Coniferous Forest", "Snowy Coniferous Forest", "Deciduous Forest", "Dense Forest", "Eucalyptus Forest",
                "Flower Field", "Flower Island", "Frost Forest", "Fungi Forest", "Garden", "Grassland", "Grove",
                "Heathland|savanna|oak", "Highland", "Lavender Fields", "Lush Swamp", "Maple Woods", "Meadow",
                "Mountain", "Mystic Grove", "Orchard", "Outback", "Prairie", "Rainforest", "Redwood Forest",
                "RedwoodForest", "Sacred Springs", "Seasonal Forest", "Shield", "Shrubland", "Steppe",
                "Temperate Rainforest", "Tropical Island", "Tropical Rainforest", "Tundra", "Wetland", "Woodland",
                "Xeric Shrubland", "Meadow Forest", "Oasis", "Scrubland", "Seasonal Forest Clearing", "Spruce Woods",
                "Mountain Foothills", "MountainFoothills",
                // ATG
                "Rocky Steppe",
                // ExtrabiomeXL
                ...
                "BiomeFlowerPall", "BiomeForestFX", "BiomeLavender", "BiomeMagic", "BiomeOasis", "BiomePineForest",
                "BiomeRichForest", "BiomeSnowmountain", "BiomeTallGrass", },
