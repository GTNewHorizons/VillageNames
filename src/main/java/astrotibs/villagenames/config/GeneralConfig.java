...
public class GeneralConfig {
	...
	protected static void loadConfiguration()
	{
		...
		componentModernSavannaTannery1_string = config.getString("Component: Modern Savanna Tannery 1", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in savanna villages");
		componentModernSavannaTannery1_vals = parseDoubleArray(componentModernSavannaTannery1_string, modernDefaults);
		
		componentModernSavannaTemple1_string = config.getString("Component: Modern Savanna Temple 1", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in savanna villages");
		componentModernSavannaTemple1_vals = parseDoubleArray(componentModernSavannaTemple1_string, modernDefaults);
		
		componentModernSavannaTemple2_string = config.getString("Component: Modern Savanna Temple 2", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in savanna villages");
		componentModernSavannaTemple2_vals = parseDoubleArray(componentModernSavannaTemple2_string, modernDefaults);
		
		componentModernSavannaToolSmith1_string = config.getString("Component: Modern Savanna Tool Smithy", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in savanna villages");
		...
		componentModernSnowyArmorerHouse2_string = config.getString("Component: Modern Snowy Armorer House 2", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in snowy villages");
		componentModernSnowyArmorerHouse2_vals = parseDoubleArray(componentModernSnowyArmorerHouse2_string, modernDefaults);
		
		componentModernSnowyButchersShop1_string = config.getString("Component: Modern Snowy Butcher House", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in snowy villages");
		componentModernSnowyButchersShop1_vals = parseDoubleArray(componentModernSnowyButchersShop1_string, modernDefaults);
		
		componentModernSnowyButchersShop2_string = config.getString("Component: Modern Snowy Butcher Igloo", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in snowy villages");
		componentModernSnowyButchersShop2_vals = parseDoubleArray(componentModernSnowyButchersShop2_string, modernDefaults);
		
		componentModernSnowyCartographerHouse1_string = config.getString("Component: Modern Snowy Cartographer House", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in snowy villages");
		...
		componentModernSnowyFarm1_string = config.getString("Component: Modern Snowy Square Farm", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in snowy villages");
		...
		componentModernSnowyShepherdsHouse1_string = config.getString("Component: Modern Snowy Shepherd House", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in snowy villages");
		componentModernSnowyShepherdsHouse1_vals = parseDoubleArray(componentModernSnowyShepherdsHouse1_string, modernDefaults);
		
		componentModernSnowySmallHouse1_string = config.getString("Component: Modern Snowy Small House 1", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in snowy villages");
		componentModernSnowySmallHouse1_vals = parseDoubleArray(componentModernSnowySmallHouse1_string, modernDefaults);
		
		componentModernSnowySmallHouse2_string = config.getString("Component: Modern Snowy Small House 2", "Village Generator", convertDoubleArrayToString(modernDefaults), "Generation stats for this component in snowy villages");
