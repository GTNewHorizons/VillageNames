...
public class AlienConfigHandler {
    ...
    public static void loadConfiguration() {
        ...
        suffix_chance = config.getFloat(
            ...
            Reference.CATEGORY_ALIEN_SYLLABLE_POOL,
            alien_root_initial.length <= 0 ? 0 : ((float) alien_suffix.length - 1) / (alien_root_initial.length - 1),
            0.0F,
            1.0F,
