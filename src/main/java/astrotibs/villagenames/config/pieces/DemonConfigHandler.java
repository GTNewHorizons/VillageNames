...
public class DemonConfigHandler
{
	...
	{
		demon_prefix = config.getString(Reference.NAME_PREFIXES, Reference.CATEGORY_DEMON_SYLLABLE_POOL, NamePiecesEntities.DEMON_PREFIX_DEFAULT,
				Reference.DESCRIPTION_PREFIXES).trim().split("\\s*,\\s*");
		
		demon_root_initial = config.getString(Reference.NAME_ROOT_INITIAL, Reference.CATEGORY_DEMON_SYLLABLE_POOL, NamePiecesEntities.DEMON_ROOT_INITIAL_DEFAULT,
				Reference.DESCRIPTION_ROOT_INITIAL).trim().split("\\s*,\\s*");
		
		demon_root_syllables = config.getString(Reference.NAME_ROOT_SYLLABLES, Reference.CATEGORY_DEMON_SYLLABLE_POOL, NamePiecesEntities.DEMON_ROOT_SYL_BEGIN_DEFAULT,
				Reference.DESCRIPTION_ROOT_SYLLABLES).trim().split("\\s*,\\s*");
		
		demon_root_terminal = config.getString(Reference.NAME_ROOT_TERMINAL, Reference.CATEGORY_DEMON_SYLLABLE_POOL, NamePiecesEntities.DEMON_ROOT_TERMINAL_DEFAULT,
				Reference.DESCRIPTION_ROOT_TERMINAL).trim().split("\\s*,\\s*");
		
		demon_suffix = config.getString("Suffixes", Reference.CATEGORY_DEMON_SYLLABLE_POOL, NamePiecesEntities.DEMON_SUFFIX_DEFAULT,
