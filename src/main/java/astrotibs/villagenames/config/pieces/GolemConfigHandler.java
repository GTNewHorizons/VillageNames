...
public class GolemConfigHandler
{
	...
	{
		golem_prefix = config.getString(Reference.NAME_PREFIXES, Reference.CATEGORY_GOLEM_SYLLABLE_POOL, NamePiecesEntities.GOLEM_PREFIX_DEFAULT,
				Reference.DESCRIPTION_PREFIXES).trim().split("\\s*,\\s*");
		
		golem_root_initial = config.getString(Reference.NAME_ROOT_INITIAL, Reference.CATEGORY_GOLEM_SYLLABLE_POOL, NamePiecesEntities.GOLEM_ROOT_INITIAL_DEFAULT,
				Reference.DESCRIPTION_ROOT_INITIAL).trim().split("\\s*,\\s*");
		
		golem_root_syllables = config.getString(Reference.NAME_ROOT_SYLLABLES, Reference.CATEGORY_GOLEM_SYLLABLE_POOL, NamePiecesEntities.GOLEM_ROOT_SYL_BEGIN_DEFAULT,
				Reference.DESCRIPTION_ROOT_SYLLABLES).trim().split("\\s*,\\s*");
		
		golem_root_terminal = config.getString(Reference.NAME_ROOT_TERMINAL, Reference.CATEGORY_GOLEM_SYLLABLE_POOL, NamePiecesEntities.GOLEM_ROOT_TERMINAL_DEFAULT,
