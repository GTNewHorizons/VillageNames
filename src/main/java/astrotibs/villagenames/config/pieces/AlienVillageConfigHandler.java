...
public class AlienVillageConfigHandler {
    ...
    public static void loadConfiguration() {
        ...
        alienvillage_root_initial = config
            .getStringWithoutDefaultsInComment(
        ...
        alienvillage_root_syllables = config
            .getStringWithoutDefaultsInComment(
        ...
        alienvillage_root_terminal = config
            .getStringWithoutDefaultsInComment(
