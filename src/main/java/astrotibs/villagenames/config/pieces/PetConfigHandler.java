...
public class PetConfigHandler {
    ...
    public static void loadConfiguration() {
        ...
        prefix_chance = config.getFloat(
            ...
            Reference.CATEGORY_PET_SYLLABLE_POOL,
            (pet_root_initial.length - 1) <= 0 ? 0 : ((float) pet_prefix.length - 1) / (pet_root_initial.length - 1),
            0.0F,
            1.0F,
        ...
        suffix_chance = config.getFloat(
            ...
            Reference.CATEGORY_PET_SYLLABLE_POOL,
            (pet_root_initial.length - 1) <= 0 ? 0 : ((float) pet_suffix.length - 1) / (pet_root_initial.length - 1),
            0.0F,
            1.0F,
