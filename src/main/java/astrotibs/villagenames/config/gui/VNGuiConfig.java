...
public class VNGuiConfig extends GuiConfig {
    ...
    public VNGuiConfig(GuiScreen guiScreen) {
        super(
            ...
            getHeader() // title: the desired title for this screen. For consistency it is recommended that you pass the
                        // path of the config file being edited.
        );
    }

    // I was going to use this to warn the player if they had an old config folder but I kind of don't care
    private static String getHeader() {
        return EnumChatFormatting.YELLOW + VillageNames.configDirectory.getAbsolutePath();
    }
