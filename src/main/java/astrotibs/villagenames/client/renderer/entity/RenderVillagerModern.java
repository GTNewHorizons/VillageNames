...
public class RenderVillagerModern extends RenderVillager {
    ...
    private Object[] setModularVillagerTexturePaths(EntityVillager villager) {
        ...
        if (!trimmed_lc_villager_name.equals(Reference.NAME_TIBS)
                ...
                & !(trimmed_lc_villager_name.length() >= 11
                        && trimmed_lc_villager_name.substring(0, 11).equals(Reference.NAME_ASTROTIBS_OPENP))
                & !(trimmed_lc_villager_name.length() >= 6
                        && trimmed_lc_villager_name.substring(0, 6).equals(Reference.NAME_TIBS_OPENP))) {
        ...
        if (!villager.isChild()) {
                                                                                               ...
                                                                                               // blank
            {
                ...
                final ResourceLocation modCareerSkin = new ResourceLocation(
                        MIDLC,
                        (new StringBuilder()).append(VAD).append("profession/").append(profRootName).append(".png")
                                .toString());
