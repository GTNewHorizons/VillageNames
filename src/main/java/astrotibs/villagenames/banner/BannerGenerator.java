...
public class BannerGenerator {
    ...
    public static Object[] randomBannerArrays(Random random, int forceBannerColor, int forceBannerColor2) {
        ...
        while (true) {
             ...
             * Column 3 is a corresponding int array instructing the generator whether any base colors should be re-used
             * in the accent.
             * 
            ...
            if (baseTemplateLengthWithoutTriggers == 0 && // There is no base pattern, and...
                ((accentColors.length == 1 && accentColors[0] != -2) // ...the single accent pattern doesn't add any new
                                                                     // colors
                    || (accentColors.length == 2 && (accentColors[0] != -2 && accentColors[1] != -2) // ...the double
                                                                                                     // accent pattern
                                                                                                     // doesn't add any
                                                                                                     // new colors
                    )) || illegalcolors) {
            ...
            if (baseTemplateLengthWithoutTriggers == baseColors.length
                ...
                && (baseTemplateLengthWithoutTriggers + accentTemplate.length
                    - (accentTemplate.length > 0 && accentTemplate[0].equals("BEHIND") ? 1 : 0)) <= 6 // You are limited
                                                                                                      // to six layers
                                                                                                      // in survival
                && (baseTemplateLengthWithoutTriggers + accentTemplate.length
                    - (accentTemplate.length > 0 && accentTemplate[0].equals("BEHIND") ? 1 : 0)) > 0 // I'd rather not
                                                                                                     // have completely
                                                                                                     // blank banners
            ) {
                break;
                ...
                for (int i : bannerColors) {
                    if (i == newpotentialcolor // Color is already in the set, so reject it.
                        ...
                        || ((i == 2 && newpotentialcolor == 10) || (i == 10 && newpotentialcolor == 2)) // Lime and
                                                                                                        // Green
                        || ((i == 5 && newpotentialcolor == 13) || (i == 13 && newpotentialcolor == 5)) // Magenta and
                                                                                                        // Purple
                        || ((i == 6 && newpotentialcolor == 12) || (i == 12 && newpotentialcolor == 6)) // Light Blue
                                                                                                        // and Cyan
                    ) {
                        flag = false;
                        break;
